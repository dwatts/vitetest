import{i6 as m,i7 as v,i8 as P,aQ as f,i9 as u,ia as y,ib as O,ic as A,id as $,hv as r,ie as g,ig as S,ih as c,ii as C,aF as E,ij as x,ik as _,ai as o,il as n,im as d,io as w,ip as b,iq as N,ir as D,is as M,it as I,iu as R,iv as F,iw as L,ix as U,iy as B,iz as G,iA as W,iB as z,iC as H,iD as j,iE as q,hw as p,iF as Q,iG as V,iH as k,iI as J}from"./index-4a2a8e32.js";function K(a){const e=new m,{vertex:t,fragment:i}=e;return v(t,a),e.include(P,a),e.attributes.add(f.POSITION,"vec3"),e.attributes.add(f.UV0,"vec2"),e.varyings.add("vpos","vec3"),a.hasMultipassTerrain&&e.varyings.add("depth","float"),t.code.add(u`
    void main(void) {
      vpos = position;
