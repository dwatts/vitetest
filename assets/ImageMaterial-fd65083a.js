import{i5 as m,i6 as v,i7 as P,aQ as f,i8 as u,i9 as y,ia as O,ib as A,ic as $,hu as r,id as g,ie as S,ig as c,ih as C,aF as E,ii as x,ij as _,ai as o,ik as n,il as d,im as w,io as b,ip as N,iq as D,ir as M,is as R,it as I,iu as F,iv as L,iw as U,ix as B,iy as G,iz as W,iA as z,iB as H,iC as j,iD as q,hv as p,iE as Q,iF as V,iG as k,iH as J}from"./index-92a868dd.js";function K(a){const e=new m,{vertex:t,fragment:i}=e;return v(t,a),e.include(P,a),e.attributes.add(f.POSITION,"vec3"),e.attributes.add(f.UV0,"vec2"),e.varyings.add("vpos","vec3"),a.hasMultipassTerrain&&e.varyings.add("depth","float"),t.code.add(u`
    void main(void) {
      vpos = position;
