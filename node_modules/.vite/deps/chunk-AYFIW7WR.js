...
var o2 = 180 / Math.PI;
var i2 = 5;
var s7 = new s5({ esriMetersPerSecond: "meter-per-second", esriKilometersPerHour: "kilometer-per-hour", esriKnots: "knots", esriFeetPerSecond: "feet-per-second", esriMilesPerHour: "mile-per-hour" });
function a4(t3, e3) {
...
function p4(t3, n3) {
  ...
  if (n3.mask || a6.fill(255), "vector-uv" === t3)
    ...
    for (let s9 = 0; s9 < o3 * l5; s9++) {
      const t4 = r3[0][s9], n4 = M(r3[1][s9]), o4 = Math.cos(n4 - Math.PI / 2), l6 = Math.sin(n4 - Math.PI / 2);
...
async function g3(t3, e3, n3, r3, a6, s9) {
  ...
  for (let o3 = 0; o3 < d5; o3++) {
    const n4 = new M2({ xmin: g4, xmax: g4 + w4, ymin: e3.ymin, ymax: e3.ymax, spatialReference: e3.spatialReference });
...
//# sourceMappingURL=chunk-AYFIW7WR.js.map
