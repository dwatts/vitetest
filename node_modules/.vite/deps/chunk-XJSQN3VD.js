...
var re = class extends s4(a3(m)) {
  ...
  initialize() {
    ...
    this._graphicStore = new b(this.view.featuresTilingScheme, this.view.state.scale, this.uid, this.graphics, e9, t7, this._hashToCIM), this._meshFactory = new a4(null, this.uid, s8), this._templateStore = s8, this.handles.add([l2(() => this._effectiveRenderer, (e10) => {
  ...
  async _addNewTile(e9, t7) {
    ...
    if (t7) {
      ...
      for (const e10 of i5)
        e10.geometry && (l(e10.geometry) || u2(e10.geometry)) && this._wrapPoints(e10, s9);
    }
    const r8 = e9.key;
  ...
  _getGraphicsData(e9, t7, s8) {
    ...
    if (r8) {
      ...
      for (const t8 of o9)
        t8.geometry && (l(t8.geometry) || u2(t8.geometry)) && this._wrapPoints(t8, e10);
    }
    return o9;
  }
  _wrapPoints(e9, t7) {
...
//# sourceMappingURL=chunk-XJSQN3VD.js.map
