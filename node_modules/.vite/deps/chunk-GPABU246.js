...
var s = 1 / has("mapview-transitions-duration");
var i = class extends n {
  ...
  updateTransitionProperties(e, t) {
    if (this.fadeTransitionEnabled) {
      const t2 = this._fadeOutResolver || !this.visible ? 0 : this.opacity, i2 = this.computedOpacity;
      if (i2 === t2)
        this.computedVisible = this.visible;
      else {
        const r = e * s;
        this.computedOpacity = i2 > t2 ? Math.max(t2, i2 - r) : Math.min(t2, i2 + r), this.computedVisible = this.computedOpacity > 0;
...
//# sourceMappingURL=chunk-GPABU246.js.map
