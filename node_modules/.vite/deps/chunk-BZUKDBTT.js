...
var l;
var a = { exports: {} };
a.exports, l = a, function(e3) {
  var r2 = ["<<=", ">>=", "++", "--", "<<", ">>", "<=", ">=", "==", "!=", "&&", "||", "+=", "-=", "*=", "/=", "%=", "&=", "^^", "^=", "|=", "(", ")", "[", "]", ".", "!", "~", "*", "/", "%", "+", "-", "<", ">", "&", "^", "|", "?", ":", "=", ",", ";", "{", "}"];
  void 0 !== r2 && (l.exports = r2);
}();
var g = t(a.exports);
var i = { exports: {} };
i.exports, function(e3) {
  !function(r2) {
    var t3 = function() {
...
function E() {
  var t3, e3, a3, E2 = 0, _3 = 0, v2 = i2, j2 = [], A2 = [], x2 = 1, D2 = 0, R2 = 0, T2 = false, G2 = false, S2 = "";
  return function(t4) {
  ...
  function F2(e4) {
    var r2;
    for (E2 = 0, a3 = (S2 += e4).length; t3 = S2[E2], E2 < a3; ) {
      switch (r2 = E2, v2) {
        case c2:
          E2 = V2();
          break;
  ...
  function C2() {
    return j2 = j2.length ? [] : j2, "/" === e3 && "*" === t3 ? (R2 = _3 + E2 - 1, v2 = c2, e3 = t3, E2 + 1) : "/" === e3 && "/" === t3 ? (R2 = _3 + E2 - 1, v2 = u, e3 = t3, E2 + 1) : "#" === t3 ? (v2 = p, R2 = _3 + E2, E2) : /\s/.test(t3) ? (v2 = g2, R2 = _3 + E2, E2) : (T2 = /\d/.test(t3), G2 = /[^\w_]/.test(t3), R2 = _3 + E2, v2 = T2 ? f : G2 ? d : s, E2);
  }
  function H3() {
    return /[^\s]/g.test(t3) ? (X2(j2.join("")), v2 = i2, E2) : (j2.push(t3), e3 = t3, E2 + 1);
  }
  function M() {
    return "\r" !== t3 && "\n" !== t3 || "\\" === e3 ? (j2.push(t3), e3 = t3, E2 + 1) : (X2(j2.join("")), v2 = i2, E2);
  }
  function P() {
    return M();
  }
  function V2() {
    return "/" === t3 && "*" === e3 ? (j2.push(t3), X2(j2.join("")), v2 = i2, E2 + 1) : (j2.push(t3), e3 = t3, E2 + 1);
  }
  function O() {
    if ("." === e3 && /\d/.test(t3))
      return v2 = l2, E2;
    ...
    return j2.push(t3), e3 = t3, E2 + 1;
  }
  function N(t4) {
    for (var e4, a4, n3 = 0; ; ) {
      if (e4 = g.indexOf(t4.slice(0, t4.length + n3).join("")), a4 = g[e4], -1 === e4) {
        if (n3-- + t4.length > 0)
          continue;
  ...
  function W() {
    return /[^a-fA-F0-9]/.test(t3) ? (X2(j2.join("")), v2 = i2, E2) : (j2.push(t3), e3 = t3, E2 + 1);
  }
  function $() {
    return "." === t3 || /[eE]/.test(t3) ? (j2.push(t3), v2 = l2, e3 = t3, E2 + 1) : "x" === t3 && 1 === j2.length && "0" === j2[0] ? (v2 = k, j2.push(t3), e3 = t3, E2 + 1) : /[^\d]/.test(t3) ? (X2(j2.join("")), v2 = i2, E2) : (j2.push(t3), e3 = t3, E2 + 1);
  }
  function z() {
    return "f" === t3 && (j2.push(t3), e3 = t3, E2 += 1), /[eE]/.test(t3) || "-" === t3 && /[eE]/.test(e3) ? (j2.push(t3), e3 = t3, E2 + 1) : /[^\d]/.test(t3) ? (X2(j2.join("")), v2 = i2, E2) : (j2.push(t3), e3 = t3, E2 + 1);
  }
  function I() {
    if (/[^\d\w_]/.test(t3)) {
      var a4 = j2.join("");
...
function _(t3) {
  var e3 = E(), a3 = [];
  return a3 = (a3 = a3.concat(e3(t3))).concat(e3(null));
}
function v(t3) {
  return _(t3);
}
...
function x(t3, e3 = "100", a3 = "300 es") {
...
function R(t3, e3, a3, r2) {
  r2 = r2 || a3;
  for (const n3 of t3)
    if ("ident" === n3.type && n3.data === a3) {
      r2 in e3 ? e3[r2]++ : e3[r2] = 0;
      return R(t3, e3, r2 + "_" + e3[r2], r2);
    }
  return a3;
}
function T(t3, e3, a3 = "afterVersion") {
  function r2(t4, e4) {
    for (let a4 = e4; a4 < t4.length; a4++) {
      const e5 = t4[a4];
  ...
  const o2 = { data: "\n", type: "whitespace" }, i3 = (e4) => e4 < t3.length && /[^\r\n]$/.test(t3[e4].data);
  let s3 = n3(t3);
...
function G(t3, e3, a3, r2 = "lowp") {
  T(t3, [{ type: "keyword", data: "out" }, { type: "whitespace", data: " " }, { type: "keyword", data: r2 }, { type: "whitespace", data: " " }, { type: "keyword", data: a3 }, { type: "whitespace", data: " " }, { type: "ident", data: e3 }, { type: "operator", data: ";" }], "afterPrecision");
}
function S(t3, e3, a3, r2, n3 = "lowp") {
  T(t3, [{ type: "keyword", data: "layout" }, { type: "operator", data: "(" }, { type: "keyword", data: "location" }, { type: "whitespace", data: " " }, { type: "operator", data: "=" }, { type: "whitespace", data: " " }, { type: "integer", data: r2.toString() }, { type: "operator", data: ")" }, { type: "whitespace", data: " " }, { type: "keyword", data: "out" }, { type: "whitespace", data: " " }, { type: "keyword", data: n3 }, { type: "whitespace", data: " " }, { type: "keyword", data: a3 }, { type: "whitespace", data: " " }, { type: "ident", data: e3 }, { type: "operator", data: ";" }], "afterPrecision");
}
function X(t3, e3) {
  let a3, r2, n3 = -1;
  for (let o2 = e3; o2 < t3.length; o2++) {
    const e4 = t3[o2];
    if ("operator" === e4.type && ("[" === e4.data && (a3 = o2), "]" === e4.data)) {
      r2 = o2;
      break;
    }
    "integer" === e4.type && (n3 = parseInt(e4.data, 10));
  }
    ...
    switch (a4.type) {
      ...
      case "builtin":
        if (/^texture(2D|Cube)(Proj)?(Lod|Grad)?(EXT)?$/.test(a4.data.trim()) && (a4.data = a4.data.replaceAll(/(2D|Cube|EXT)/g, "")), r2 === H.FRAGMENT_SHADER && "gl_FragColor" === a4.data && (i3 || (i3 = R(o2, c4, "fragColor"), G(o2, i3, "vec4")), a4.data = i3), r2 === H.FRAGMENT_SHADER && "gl_FragData" === a4.data) {
          const t3 = X(o2, p2 + 1), e3 = R(o2, c4, "fragData");
          S(o2, e3, "vec4", t3, "mediump"), a4.data = e3;
        } else
  ...
  for (let t3 = o2.length - 1; t3 >= 0; --t3) {
    ...
    if ("preprocessor" === e3.type) {
      ...
      if (a4 && a4[1] && A.includes(a4[1].trim())) {
        const e4 = o2[t3 + 1];
        o2.splice(t3, e4 && "whitespace" === e4.type ? 2 : 1);
      }
      const r3 = e3.data.match(/\#ifdef\s+(.*)/);
      r3 && r3[1] && A.includes(r3[1].trim()) && (e3.data = "#if 1");
      const n4 = e3.data.match(/\#ifndef\s+(.*)/);
      n4 && n4[1] && A.includes(n4[1].trim()) && (e3.data = "#if 0");
    }
  }
  return H2(a3, j(o2));
}
...
function H2(t3, e3) {
  return e2.enableCache && L.set(t3, e3), e3;
}
...
validated: ${_3.getProgramParameter(l3, _3.VALIDATE_STATUS)}, gl error ${_3.getError()}, vertex: ${_3.getShaderParameter(this._vShader, _3.COMPILE_STATUS)}, fragment: ${_3.getShaderParameter(this._fShader, _3.COMPILE_STATUS)}, info log: ${_3.getProgramInfoLog(l3)}, vertex source: ${this.vertexShader}, fragment source: ${this.fragmentShader}`), this._context.type === n.WEBGL2) {
      ...
      for (const [o2, i3] of this._uniformBlockBindings) {
        const e3 = t4.getUniformBlockIndex(l3, o2);
        e3 < s2 && t4.uniformBlockBinding(l3, e3, i3);
      }
    }
  ...
  setUniform2f(t3, o2, i3) {
    ...
    void 0 === e3 ? (this._context.gl.uniform2f(this._getUniformLocation(t3), o2, i3), this._nameToUniform2.set(t3, [o2, i3])) : o2 === e3[0] && i3 === e3[1] || (this._context.gl.uniform2f(this._getUniformLocation(t3), o2, i3), e3[0] = o2, e3[1] = i3);
  }
  setUniform2fv(t3, o2) {
    c3(this._nameToUniform2, t3, o2) && this._context.gl.uniform2fv(this._getUniformLocation(t3), o2);
  }
  setUniform3f(t3, o2, i3, e3) {
    const n3 = this._nameToUniform3.get(t3);
    void 0 === n3 ? (this._context.gl.uniform3f(this._getUniformLocation(t3), o2, i3, e3), this._nameToUniform3.set(t3, [o2, i3, e3])) : o2 === n3[0] && i3 === n3[1] && e3 === n3[2] || (this._context.gl.uniform3f(this._getUniformLocation(t3), o2, i3, e3), n3[0] = o2, n3[1] = i3, n3[2] = e3);
  }
  setUniform3fv(t3, o2) {
    c3(this._nameToUniform3, t3, o2) && this._context.gl.uniform3fv(this._getUniformLocation(t3), o2);
  }
  setUniform4f(t3, o2, i3, e3, n3) {
    const r2 = this._nameToUniform4.get(t3);
    void 0 === r2 ? (this._context.gl.uniform4f(this._getUniformLocation(t3), o2, i3, e3, n3), this._nameToUniform4.set(t3, [o2, i3, e3, n3])) : void 0 !== r2 && o2 === r2[0] && i3 === r2[1] && e3 === r2[2] && n3 === r2[3] || (this._context.gl.uniform4f(this._getUniformLocation(t3), o2, i3, e3, n3), r2[0] = o2, r2[1] = i3, r2[2] = e3, r2[3] = n3);
  }
  setUniform4fv(t3, o2) {
...
function c3(o2, i3, e3) {
  const n3 = o2.get(i3);
  return n3 ? h(n3, e3) : (o2.set(i3, Array.from(e3)), true);
}
...
//# sourceMappingURL=chunk-BZUKDBTT.js.map
