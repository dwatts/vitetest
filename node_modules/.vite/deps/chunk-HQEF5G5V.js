...
var l = /[#0,]*[#0](?:\.0*#*)?/;
function o2(e, t, n2) {
  const r2 = (n2 = n2 || {}).customs.group, s2 = n2.customs.decimal, o3 = t.split(";"), c2 = o3[0];
  if ((t = o3[e < 0 ? 1 : 0] || "-" + c2).includes("%"))
    e *= 100;
  else if (t.includes("‰"))
    e *= 1e3;
  else {
...
function i(e, t, n2) {
  ...
  let a2 = c2.indexOf("0");
  -1 !== a2 && (a2 = c2.length - a2, a2 > o3[0].length && (o3[0] = o3[0].padStart(a2, "0")), c2.includes("#") || (o3[0] = o3[0].substr(o3[0].length - a2)));
...
function a(t) {
  ...
  const p2 = g(a2, (n3) => (n3 = "(?:" + o(n3, ".") + ")").replace(l, (e) => {
  ...
  return { regexp: p2.replaceAll(/[\xa0 ]/g, "[\\s\\xa0]"), group: o3, decimal: i2, factor: c2 };
}
function p(e, t) {
...
function u(e) {
  "places" in (e = e || {}) || (e.places = 1 / 0), "string" != typeof e.decimal && (e.decimal = "."), "fractional" in e && !/^0/.test(String(e.places)) || (e.fractional = [true, false]), "exponent" in e || (e.exponent = [true, false]), "eSigned" in e || (e.eSigned = [true, false]);
...
//# sourceMappingURL=chunk-HQEF5G5V.js.map
