...
var f = class extends a2(m2(m)) {
  ...
  _startup() {
    const { layer: e2, layerView: t } = this, { spatialReference: r2, definitionExpression: s2, geometryDefinition: o5, objectIdField: i, timeInfo: n2, purgeOptions: c, maxReconnectionAttempts: d2, maxReconnectionInterval: u2, customParameters: m5 } = e2, f2 = e2.geometryType ? o.toJSON(e2.geometryType) : null, g = r2, I = t.view.spatialReference, _ = { geometry: o5, where: s2 };
    this.clear(), this._set("connection", o3(e2.parsedUrl, g, I, f2, _, d2, u2, m5 ?? void 0)), this._outSpatialReference = I.toJSON(), this.store = new y2(this._onUpdate.bind(this)), this.featuresManager = new o2(this.store, i, n2.toJSON(), c);
...
//# sourceMappingURL=StreamLayerView3D-ZCGU5RGY.js.map
