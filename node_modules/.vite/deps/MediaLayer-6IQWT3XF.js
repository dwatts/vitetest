...
var O2 = class extends u(a4) {
  ...
  set coords(o4) {
    ...
    if (null == (o4 = this.projectOrWarn(o4, t4)))
      return;
    const { width: r5, height: n7 } = this, { rings: [[e3, s5, c6, a6]] } = o4, p2 = { sourcePoint: c2(0, n7), mapPoint: new x({ x: e3[0], y: e3[1], spatialReference: t4 }) }, u3 = { sourcePoint: c2(0, 0), mapPoint: new x({ x: s5[0], y: s5[1], spatialReference: t4 }) }, m5 = { sourcePoint: c2(r5, 0), mapPoint: new x({ x: c6[0], y: c6[1], spatialReference: t4 }) }, f3 = { sourcePoint: c2(r5, n7), mapPoint: new x({ x: a6[0], y: a6[1], spatialReference: t4 }) };
  ...
  toSource(o4) {
    if (null == o4 || null == this.inverseTransform || null == this.controlPoints || !k(this.controlPoints[0]))
      return null;
    const t4 = this.controlPoints[0].mapPoint.spatialReference;
    return o4 = o4.normalize(), null == (o4 = tn(o4, t4).geometry) ? null : (r3(T, o4.x, o4.y), h(T, T, this.inverseTransform), c2(T[0], T[1]));
  }
  _updateTransform(o4) {
...
e([y({ type: [_2], json: { write: { allowNull: false, isRequired: true } } })], O2.prototype, "controlPoints", void 0), e([o("controlPoints")], O2.prototype, "readControlPoints", null), e([r2("controlPoints")], O2.prototype, "writeControlPoints", null), e([y()], O2.prototype, "coords", null), e([y({ json: { write: true } })], O2.prototype, "height", void 0), e([y({ readOnly: true })], O2.prototype, "inverseTransform", null), e([y({ readOnly: true })], O2.prototype, "transform", null), e([y({ json: { write: true } })], O2.prototype, "width", void 0), O2 = e([a("esri.layers.support.ControlPointsGeoreference")], O2);
var b2 = n4();
var I = n4();
var M2 = n4();
var N = n4();
...
function K(o4, t4, r5, n7) {
  ...
  return h(e3, e3, o4), h(s5, s5, o4), h(l4, l4, o4), h(c6, c6, o4), new j({ rings: [[e3, s5, l4, c6, e3]], spatialReference: n7 });
}
var Q = O2;
...
var n5 = class extends a4 {
  ...
  get coords() {
    ...
    return e3 = this.projectOrWarn(e3, p2), o4 = this.projectOrWarn(o4, p2), r5 = this.projectOrWarn(r5, p2), null == e3 || null == o4 || null == r5 ? null : new j({ rings: [[[o4.x, o4.y], [t4.x, t4.y], [e3.x, e3.y], [r5.x, r5.y], [o4.x, o4.y]]], spatialReference: p2 });
  }
  set coords(t4) {
...
var c5 = class extends a4 {
  ...
  get coords() {
    ...
    return new j({ rings: [n7], spatialReference: s5 });
  }
  set coords(t4) {
    ...
    if (null == (t4 = this.projectOrWarn(t4, r5)) || null == t4.extent)
      return;
    const { rings: [[o4, s5, i5]], extent: { center: { x: a6, y: c6 } } } = t4, m5 = m2(Math.PI / 2 - Math.atan2(s5[1] - o4[1], s5[0] - o4[0])), l4 = p(a6, c6, -m5), [u3, x3] = l4(o4[0], o4[1]), [h2, f3] = l4(i5[0], i5[1]);
    this.extent = new M({ xmin: u3, ymin: x3, xmax: h2, ymax: f3, spatialReference: r5 }), this.rotation = m5;
  }
};
function p(t4, e3, r5) {
  const o4 = r(r5), n7 = Math.cos(o4), i5 = Math.sin(o4);
...
var j4 = class extends d {
  ...
  load() {
    const e3 = this.image;
    if ("string" == typeof e3) {
      const r5 = j2(e3, { responseType: "image" }).then(({ data: e4 }) => {
  ...
  writeImage(e3, t4, r5, n7) {
    ...
    if (!a6 || !m5)
      return void ("string" == typeof e3 && (t4[r5] = c(e3, n7)));
    const p2 = "string" != typeof e3 || tt(e3) || Z(e3) ? null : e3;
    if (p2) {
      if (null == v(p2))
        return void (t4[r5] = p2);
      const e4 = c(p2, { ...n7, verifyItemRelativeUrls: n7 && n7.verifyItemRelativeUrls ? { writtenUrls: n7.verifyItemRelativeUrls.writtenUrls, rootPath: void 0 } : void 0 }, R.NO);
      if (a6 && e4 && !Y(e4))
...
e([y({ readOnly: true })], j4.prototype, "content", void 0), e([y({ json: { name: "url", type: String } })], j4.prototype, "image", void 0), e([o("image", ["url"])], j4.prototype, "readImage", null), e([r2("image")], j4.prototype, "writeImage", null), e([y({ readOnly: true, json: { name: "mediaType" } })], j4.prototype, "type", void 0), j4 = e([a("esri.layers.support.ImageElement")], j4);
var I2 = j4;
async function w(e3) {
  if ("string" == typeof e3) {
    if (Z(e3)) {
      const { data: r5 } = await j2(e3, { responseType: "blob" });
      return r5;
    }
    if (tt(e3))
      return st(e3);
    return w((await j2(e3, { responseType: "image" })).data);
  }
...
function T2(e3, t4) {
  const r5 = n2(), o4 = `${V2("media", r5)}.${t3(e3)}`;
...
var I3 = V.ofType(M3);
var S2 = class extends _.LoadableMixin(m3(a3(n.EventedAccessor))) {
  constructor(e3) {
    super(e3), this._index = new o3(), this._elementViewsMap = /* @__PURE__ */ new Map(), this._elementsIndexes = /* @__PURE__ */ new Map(), this._elementsChangedHandler = (e4) => {
      ...
      for (const s5 of e4.added) {
        ...
        const r5 = l2(() => e5.coords, () => this._updateIndexForElement(e5, false));
  ...
  set elements(e3) {
    this._set("elements", n3(e3, this._get("elements"), I3));
  }
  get fullExtent() {
...
e([y({ readOnly: true })], g.prototype, "effectiveSource", void 0), e([y({ type: String })], g.prototype, "copyright", void 0), e([y({ readOnly: true })], g.prototype, "fullExtent", null), e([y({ type: ["MediaLayer"] })], g.prototype, "operationalLayerType", void 0), e([y({ type: ["show", "hide"] })], g.prototype, "listMode", void 0), e([y({ nonNullable: true, json: { write: { enabled: true, allowNull: false } } })], g.prototype, "source", null), e([s4("source")], g.prototype, "castSource", null), e([o("source", ["url"])], g.prototype, "readSource", null), e([r2("source")], g.prototype, "writeSource", null), e([y()], g.prototype, "spatialReference", void 0), e([y({ readOnly: true })], g.prototype, "type", void 0), g = e([a("esri.layers.MediaLayer")], g);
var j5 = g;
export {
  j5 as default
};
//# sourceMappingURL=MediaLayer-6IQWT3XF.js.map
