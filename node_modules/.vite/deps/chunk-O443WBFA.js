...
var c2;
var n2 = new s2({ count: "count", sum: "sum", min: "min", max: "max", avg: "avg", stddev: "stddev", var: "var", exceedslimit: "exceedslimit", percentile_cont: "percentile-continuous", percentile_disc: "percentile-discrete", EnvelopeAggregate: "envelope-aggregate", CentroidAggregate: "centroid-aggregate", ConvexHullAggregate: "convex-hull-aggregate" });
...
var w;
var v2 = new s2({ esriSpatialRelIntersects: "intersects", esriSpatialRelContains: "contains", esriSpatialRelCrosses: "crosses", esriSpatialRelDisjoint: "disjoint", esriSpatialRelEnvelopeIntersects: "envelope-intersects", esriSpatialRelIndexIntersects: "index-intersects", esriSpatialRelOverlaps: "overlaps", esriSpatialRelTouches: "touches", esriSpatialRelWithin: "within", esriSpatialRelRelation: "relation" });
var g = new s2({ esriSRUnit_Meter: "meters", esriSRUnit_Kilometer: "kilometers", esriSRUnit_Foot: "feet", esriSRUnit_StatuteMile: "miles", esriSRUnit_NauticalMile: "nautical-miles", esriSRUnit_USNauticalMile: "us-nautical-miles" });
...
R.MAX_MAX_RECORD_COUNT_FACTOR = 5, e([y({ json: { write: true } })], R.prototype, "aggregateIds", void 0), e([y({ type: Boolean, json: { write: true } })], R.prototype, "cacheHint", void 0), e([y({ type: Boolean, json: { default: false, write: true } })], R.prototype, "compactGeometryEnabled", void 0), e([y({ json: { write: true } })], R.prototype, "datumTransformation", void 0), e([s("datumTransformation")], R.prototype, "castDatumTransformation", null), e([y({ type: Boolean, json: { default: false, write: true } })], R.prototype, "defaultSpatialReferenceEnabled", void 0), e([y({ type: Number, json: { write: { overridePolicy: (t) => ({ enabled: t > 0 }) } } })], R.prototype, "distance", void 0), e([y({ type: K, json: { write: true } })], R.prototype, "dynamicDataSource", void 0), e([y({ type: String, json: { write: true } })], R.prototype, "formatOf3DObjects", void 0), e([y({ type: [i2], json: { write: { enabled: true, overridePolicy() {
...
//# sourceMappingURL=chunk-O443WBFA.js.map
