...
var n2 = class extends m {
  ...
  async update(t, r) {
    const { addOrUpdateResource: e3 } = await import("./resourceUtils-BYTAK7WC.js");
...
var S = f = class extends u2(_2) {
  ...
  async fetchResources(e3 = {}, t) {
    const { fetchResources: i } = await import("./resourceUtils-BYTAK7WC.js");
    return i(this, e3, t);
  }
  async addResource(e3, t, i) {
    const { addOrUpdateResource: r } = await import("./resourceUtils-BYTAK7WC.js");
    return e3.portalItem = this, r(e3, "add", t, i);
  }
  async removeResource(e3, t) {
    const { removeResource: i } = await import("./resourceUtils-BYTAK7WC.js");
  ...
  async removeAllResources(e3) {
    const { removeAllResources: t } = await import("./resourceUtils-BYTAK7WC.js");
    return t(this, e3);
  }
  resourceFromPath(e3) {
...
//# sourceMappingURL=chunk-2CTB7MKH.js.map
