...
function o2(e) {
  const t = y(e);
  return t ? h(t) ? t.map((e2) => e2.toJSON()) : t.map(({ scale: e2, effects: t2 }) => ({ scale: e2, value: t2.map((e3) => e3.toJSON()) })) : null;
}
function c(e) {
  if (!e || 0 === e.length)
    return null;
  ...
  for (const s2 of e) {
    ...
    switch (s2.type) {
      ...
      case "hue-rotate":
        ...
        break;
      case "drop-shadow":
        e2 = [u(s2, "xoffset", "pt"), u(s2, "yoffset", "pt"), u(s2, "blurRadius", "pt"), l(s2, "color")];
        break;
      case "bloom":
...
//# sourceMappingURL=chunk-GOK4EI36.js.map
