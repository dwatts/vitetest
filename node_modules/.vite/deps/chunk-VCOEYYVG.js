...
function a4(e2, n2, t2) {
  ...
  }), i2.length && t2 && null != t2.start && null != t2.end) {
...
function u(e2, n2, t2) {
  ...
  const a5 = i2;
  if (!a5 || !(a5 == null ? void 0 : a5.length))
    return e2;
...
function f(e2, n2 = {}) {
  ...
  if (null == t2)
    return null;
  const { variableName: a5, multidimensionalSubset: s2, multidimensionalDefinition: r2 } = n2, l3 = null != r2 ? (_a = r2[0]) == null ? void 0 : _a.variableName : null, u2 = a5 || l3 || (i2 == null ? void 0 : i2.DefaultVariable);
  let { variables: o2 } = t2;
...
function d(e2, t2 = {}) {
  ...
  for (let l3 = 0; l3 < s2.length; l3++) {
    const e3 = u(s2[l3], t2.multidimensionalSubset, r2);
    if (!e3)
      return null;
...
function h(e2) {
  return !(null == e2 || !e2.length) && e2.some((e3) => {
    if (null == e3.values)
      return true;
...
function g(n2, t2) {
  ...
  return ((_a = n2 == null ? void 0 : n2.variables) == null ? void 0 : _a.length) && (i2 = i2.filter(({ name: e2 }) => n2.variables.includes(e2)), i2.forEach((t3) => {
    t3.dimensions = t3.dimensions.map((e2) => u(e2, n2, t3.name)).filter(R);
  })), i2;
}
function v(e2, n2) {
  var _a;
...
function D(e2, n2) {
  ...
  for (let s2 = 0; s2 < a5.length; s2++) {
    ...
    const l3 = r2.map((e3) => b(e3)), u2 = r2.length;
    for (let i3 = 0; i3 < u2; i3++) {
      ...
      if (-1 === a6)
        return null;
      l3.shift(), t2 += i3 === u2 - 1 ? a6 : a6 * l3.reduce((e3, n5) => e3 * n5);
    }
    break;
  }
  return t2;
...
//# sourceMappingURL=chunk-VCOEYYVG.js.map
