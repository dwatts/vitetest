...
`;
      ...
      this._allocations.forEach((t8) => {
        s4.set(t8, (s4.get(t8) ?? 0) + 1);
      }), s4.forEach((s5, o4) => {
        const i2 = o4.split("\n");
        i2.shift(), i2.shift(), t7 += `${s5}: ${i2.shift()}
`, i2.forEach((s6) => t7 += `   ${s6}
`);
      });
    }
...
var e4 = { RECORD_ALLOCATIONS: false };
var s3 = class {
  constructor() {
    for (this._current = new Array(), this._max = new Array(), this._allocations = new t5(e4.RECORD_ALLOCATIONS); this._current.length < V.COUNT; )
  ...
  increment(t7, r6) {
    const e7 = ++this._current[t7];
    this._max[t7] = Math.max(e7, this._max[t7]), this._allocations.add(r6);
  }
  decrement(t7, r6) {
...
var n5 = class _n {
  constructor(e7) {
    this._rctx = e7, this._indexBuffer = this._createIndexbuffer(), this._program = this._createHelperProgram();
  }
  static getShaderSources() {
    return { vertex: "#version 300 es\n    precision highp float;\n\n    void main(void) {\n      gl_Position = vec4(0.0, 0.0, float(gl_VertexID)-2.0, 1.0);\n    }", fragment: "#version 300 es\n    precision highp float;\n\n    out vec4 fragColor;\n\n    void main(void) {\n      fragColor = vec4(0.0, 0.0, 0.0, 1.0);\n    }" };
  }
  _createHelperProgram() {
    const e7 = _n.getShaderSources();
...
var h2 = class extends t4 {
  ...
  _test(r6) {
    ...
    e7.resetState();
    const o4 = new e2(1);
    o4.wrapMode = D.CLAMP_TO_EDGE, o4.samplingMode = L.NEAREST;
    const d3 = new x(e7, o4), h3 = c.createIndex(this._rctx, F.STATIC_DRAW, new Uint8Array([0]));
    e7.bindFramebuffer(d3), e7.setViewport(0, 0, 1, 1), e7.useProgram(this._helperProgram), e7.bindBuffer(h3, A.ELEMENT_ARRAY_BUFFER), e7.drawElements(E.POINTS, 1, C.UNSIGNED_BYTE, 0), e7.useProgram(r6), e7.bindVAO(null), e7.drawArrays(E.TRIANGLES, 0, 258);
    const _3 = new Uint8Array(4);
    return d3.readPixels(0, 0, 1, 1, G.RGBA, U.UNSIGNED_BYTE, _3), d3.dispose(), h3.dispose(), 255 === _3[0];
  }
  _prepareProgram() {
    const e7 = 85, t7 = `#version 300 es
    precision highp float;
    ...
    void main(void) {
      ...
      float offset = triangleId / ${o.float(e7)};
    ...
    void main(void) {
      fragColor = triangleId == ${o.float(e7)} ? vec4(0.0, 1.0, 0.0, 1.0) : vec4(1.0, 0.0, 0.0, 1.0);
    }
    `;
    return this._rctx.programCache.acquire(t7, o4, /* @__PURE__ */ new Map([]));
  }
  _prepareHelperProgram() {
    const r6 = n5.getShaderSources();
...
var d = class extends t4 {
  constructor(e7) {
    super(), this._rctx = e7, this._program = A2(this._rctx, false), this._obfuscated = A2(this._rctx, true);
  }
  dispose() {
  ...
  _test(e7) {
    ...
    if (null == this._obfuscated)
      return false;
    const n7 = this._runProgram(e7), o4 = this._runProgram(this._obfuscated);
    return 0 !== n7 && (0 === o4 || n7 / o4 > 5);
  }
  _runProgram(n7) {
    const _3 = this._rctx;
    _3.resetState();
    ...
    t3(F2, E3, 3), _3.useProgram(n7), n7.setUniform3f("u_highA", w[0], w[2], w[4]), n7.setUniform3f("u_lowA", w[1], w[3], w[5]), n7.setUniform3f("u_highB", E3[0], E3[2], E3[4]), n7.setUniform3f("u_lowB", E3[1], E3[3], E3[5]), _3.bindFramebuffer(A4), _3.setViewport(0, 0, 1, 1), _3.bindVAO(g4), _3.drawArrays(E.TRIANGLE_STRIP, 0, 4);
...
function A2(e7, n7) {
  ...
  return e7.programCache.acquire(o4, t7, /* @__PURE__ */ new Map([["position", 0]]));
}
...
var g2 = class extends t4 {
  constructor(e7) {
    var _a, _b, _c, _d, _e;
    if (super(), this._rctx = e7, !e7.gl)
      return;
    if (e7.type === n3.WEBGL1)
      return void (this._result = !(!((_a = e7.capabilities.textureFloat) == null ? void 0 : _a.textureFloat) || !((_b = e7.capabilities.colorBufferFloat) == null ? void 0 : _b.textureFloat)));
    if (!(((_c = e7.capabilities.textureFloat) == null ? void 0 : _c.textureFloat) && ((_d = e7.capabilities.colorBufferFloat) == null ? void 0 : _d.textureFloat) && ((_e = e7.capabilities.colorBufferFloat) == null ? void 0 : _e.floatBlend)))
      return;
    const t7 = "\n    precision highp float;\n    attribute vec2 a_pos;\n\n    void main() {\n      gl_Position = vec4(a_pos * 2.0 - 1.0, 0.0, 1.0);\n    }\n    ", o4 = "\n     precision highp float;\n\n     void main() {\n      gl_FragColor = vec4(0.5, 0.5, 0.5, 0.5);\n     }\n    ";
    this._program = e7.programCache.acquire(t7, o4, /* @__PURE__ */ new Map([["a_pos", 0]]));
  }
  _test(r6) {
...
var g3 = class extends t4 {
  constructor(e7) {
    ...
    this._program = e7.programCache.acquire(r6, t7, /* @__PURE__ */ new Map([["a_pos", 0]]));
  }
  _test(d3) {
...
var o2 = class {
  constructor(o4) {
    this.rctx = o4, this.floatBufferBlend = new g2(o4), this.svgPremultipliesAlpha = new f(o4), this.doublePrecisionRequiresObfuscation = new d(o4), this.ignoresSamplerPrecision = new g3(o4), this.drawArraysRequiresIndicesTypeReset = new h2(o4);
  }
  dispose() {
...
function A3(A4, _3) {
  ...
  if (_3.drawBuffers)
    return null;
  const e7 = A4.getExtension("WEBGL_draw_buffers");
  return e7 ? { drawBuffers: e7.drawBuffersWEBGL.bind(e7), MAX_DRAW_BUFFERS: e7.MAX_DRAW_BUFFERS_WEBGL, MAX_COLOR_ATTACHMENTS: e7.MAX_COLOR_ATTACHMENTS_WEBGL } : null;
}
...
function _2(t7, _3) {
  if (_3.compressedTextureETC)
    return null;
  const e7 = t7.getExtension("WEBGL_compressed_texture_etc");
  return e7 ? { COMPRESSED_R11_EAC: e7.COMPRESSED_R11_EAC, COMPRESSED_SIGNED_R11_EAC: e7.COMPRESSED_SIGNED_R11_EAC, COMPRESSED_RG11_EAC: e7.COMPRESSED_RG11_EAC, COMPRESSED_SIGNED_RG11_EAC: e7.COMPRESSED_SIGNED_RG11_EAC, COMPRESSED_RGB8_ETC2: e7.COMPRESSED_RGB8_ETC2, COMPRESSED_SRGB8_ETC2: e7.COMPRESSED_SRGB8_ETC2, COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2: e7.COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2, COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2: e7.COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2, COMPRESSED_RGBA8_ETC2_EAC: e7.COMPRESSED_RGBA8_ETC2_EAC, COMPRESSED_SRGB8_ALPHA8_ETC2_EAC: e7.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC } : null;
}
function e5(t7, _3) {
  if (_3.compressedTextureS3TC)
    return null;
  const e7 = t7.getExtension("WEBGL_compressed_texture_s3tc");
  return e7 ? { COMPRESSED_RGB_S3TC_DXT1: e7.COMPRESSED_RGB_S3TC_DXT1_EXT, COMPRESSED_RGBA_S3TC_DXT1: e7.COMPRESSED_RGBA_S3TC_DXT1_EXT, COMPRESSED_RGBA_S3TC_DXT3: e7.COMPRESSED_RGBA_S3TC_DXT3_EXT, COMPRESSED_RGBA_S3TC_DXT5: e7.COMPRESSED_RGBA_S3TC_DXT5_EXT } : null;
}
function E2(_3, e7) {
  if (n4(_3))
...
function n6(t7, _3) {
  if (_3.textureFilterAnisotropic)
    return null;
  const e7 = t7.getExtension("EXT_texture_filter_anisotropic") || t7.getExtension("MOZ_EXT_texture_filter_anisotropic") || t7.getExtension("WEBKIT_EXT_texture_filter_anisotropic");
  return e7 ? { MAX_TEXTURE_MAX_ANISOTROPY: e7.MAX_TEXTURE_MAX_ANISOTROPY_EXT, TEXTURE_MAX_ANISOTROPY: e7.TEXTURE_MAX_ANISOTROPY_EXT } : null;
}
function R2(_3, e7) {
  if (n4(_3))
    return { textureFloat: true, textureFloatLinear: !e7.textureFloatLinear && !!_3.getExtension("OES_texture_float_linear"), textureHalfFloat: true, textureHalfFloatLinear: true, HALF_FLOAT: _3.HALF_FLOAT, R16F: _3.R16F, RG16F: _3.RG16F, RGBA16F: _3.RGBA16F, R32F: _3.R32F, RG32F: _3.RG32F, RGBA32F: _3.RGBA32F, R11F_G11F_B10F: _3.R11F_G11F_B10F, RGB16F: _3.RGB16F };
  if (_3 instanceof WebGLRenderingContext) {
    const t7 = !e7.textureHalfFloat && _3.getExtension("OES_texture_half_float");
    return { textureFloat: !e7.textureFloat && !!_3.getExtension("OES_texture_float"), textureFloatLinear: !e7.textureFloatLinear && !!_3.getExtension("OES_texture_float_linear"), textureHalfFloat: !!t7, textureHalfFloatLinear: !e7.textureHalfFloatLinear && !!_3.getExtension("OES_texture_half_float_linear"), HALF_FLOAT: t7 ? t7.HALF_FLOAT_OES : void 0 };
  }
  return null;
}
function r4(_3, e7) {
  if (n4(_3)) {
    const t7 = !e7.colorBufferHalfFloat && _3.getExtension("EXT_color_buffer_half_float") || !e7.colorBufferFloat && _3.getExtension("EXT_color_buffer_float"), E3 = !e7.colorBufferFloat && _3.getExtension("EXT_color_buffer_float"), n7 = !e7.floatBlend && !e7.colorBufferFloat && _3.getExtension("EXT_float_blend");
    return t7 || E3 || n7 ? { textureFloat: !!E3, textureHalfFloat: !!t7, floatBlend: !!n7, R16F: _3.R16F, RG16F: _3.RG16F, RGBA16F: _3.RGBA16F, R32F: _3.R32F, RG32F: _3.RG32F, RGBA32F: _3.RGBA32F, R11F_G11F_B10F: _3.R11F_G11F_B10F, RGB16F: _3.RGB16F } : null;
  }
  if (_3 instanceof WebGLRenderingContext) {
    const t7 = !e7.colorBufferHalfFloat && _3.getExtension("EXT_color_buffer_half_float"), E3 = !e7.colorBufferFloat && _3.getExtension("WEBGL_color_buffer_float"), n7 = !e7.floatBlend && !e7.colorBufferFloat && _3.getExtension("EXT_float_blend");
    return t7 || E3 || n7 ? { textureFloat: !!E3, textureHalfFloat: !!t7, floatBlend: !!n7, RGBA16F: t7 ? t7.RGBA16F_EXT : void 0, RGB16F: t7 ? t7.RGB16F_EXT : void 0, RGBA32F: E3 ? E3.RGBA32F_EXT : void 0 } : null;
  }
  return null;
}
function o3(_3, e7, E3, n7, R3) {
  if (n7 && n4(_3))
    return true;
  if (e7[E3])
    return false;
...
function e6(e7, t7) {
  const n7 = t7.loseContext && e7.getExtension("WEBGL_lose_context");
...
function r5(r6, t7) {
  ...
  if (t7.vao)
    return null;
  const n7 = r6.getExtension("OES_vertex_array_object") || r6.getExtension("MOZ_OES_vertex_array_object") || r6.getExtension("WEBKIT_OES_vertex_array_object");
...
var d2 = class {
  constructor(t7, e7) {
    this._gl = t7, this._instancing = null, this._vertexArrayObject = null, this._compressedTextureETC = null, this._compressedTextureS3TC = null, this._textureFilterAnisotropic = null, this._textureFloat = null, this._colorBufferFloat = null, this._minMaxBlending = null, this._loseContext = null, this._drawBuffers = null, this._textureNorm16 = null, this._depthTexture = null, this._textureFloatLinear = null, this._disabledExtensions = e7.disabledExtensions || {}, this._debugWebGLExtensions = e7.debugWebGLExtensions || {};
  }
  get drawBuffers() {
  ...
  get compressedTextureS3TC() {
    return this._compressedTextureS3TC || (this._compressedTextureS3TC = e5(this._gl, this._disabledExtensions)), this._compressedTextureS3TC;
  }
  ...
  get depthTexture() {
    return null === this._depthTexture && (this._depthTexture = o3(this._gl, this._disabledExtensions, "depthTexture", true, ["WEBGL_depth_texture", "MOZ_WEBGL_depth_texture", "WEBKIT_WEBGL_depth_texture"])), this._depthTexture;
  }
  get loseContext() {
  ...
  get textureFloatLinear() {
    return null === this._textureFloatLinear && (this._textureFloatLinear = o3(this._gl, this._disabledExtensions, "textureFloatLinear", false, ["OES_texture_float_linear"])), this._textureFloatLinear;
  }
  enable(t7) {
    return this[t7];
  }
...
var P2 = class {
  constructor(t7, e7) {
    this.gl = t7, this.instanceCounter = new s3(), this.programCache = new e3(this), this._state = new h(), this._numOfDrawCalls = 0, this._numOfTriangles = 0, this.type = n4(t7) ? n3.WEBGL2 : n3.WEBGL1, this._loadExtensions(), this.configure(e7);
  }
  get gl2() {
    return this.type === n3.WEBGL1 ? null : this.gl;
  }
  configure(e7) {
    this._capabilities = new d2(this.gl, e7), this._parameters = new t6(this.gl, this._capabilities, e7), T2.TEXTURE_UNIT_FOR_UPDATES = this._parameters.maxTextureImageUnits - 1;
    const s4 = this.gl.getParameter(this.gl.VIEWPORT);
    this._state = new h(), this._state.viewport = { x: s4[0], y: s4[1], width: s4[2], height: s4[3] }, this._stateTracker = new M2({ setBlending: (t7) => {
      if (t7) {
    ...
    } }), this.enforceState(), t(this._driverTest), this._driverTest = new o2(this);
  }
  dispose() {
  ...
  externalTextureUnitUpdate(t7, e7) {
    for (let s4 = 0; s4 < t7.length; ++s4)
      this._state.textureUnitMap[t7[s4]] = null;
  ...
  setBlendColor(t7, e7, s4, i2) {
    t7 === this._state.blendColor.r && e7 === this._state.blendColor.g && s4 === this._state.blendColor.b && i2 === this._state.blendColor.a || (this.gl.blendColor(t7, e7, s4, i2), this._state.blendColor.r = t7, this._state.blendColor.g = e7, this._state.blendColor.b = s4, this._state.blendColor.a = i2, this._stateTracker.invalidateBlending());
  }
  setBlendFunction(t7, e7) {
    t7 === this._state.blendFunction.srcRGB && e7 === this._state.blendFunction.dstRGB || (this.gl.blendFunc(t7, e7), this._state.blendFunction.srcRGB = t7, this._state.blendFunction.srcAlpha = t7, this._state.blendFunction.dstRGB = e7, this._state.blendFunction.dstAlpha = e7, this._stateTracker.invalidateBlending());
  }
  setBlendFunctionSeparate(t7, e7, s4, i2) {
    this._state.blendFunction.srcRGB === t7 && this._state.blendFunction.srcAlpha === s4 && this._state.blendFunction.dstRGB === e7 && this._state.blendFunction.dstAlpha === i2 || (this.gl.blendFuncSeparate(t7, e7, s4, i2), this._state.blendFunction.srcRGB = t7, this._state.blendFunction.srcAlpha = s4, this._state.blendFunction.dstRGB = e7, this._state.blendFunction.dstAlpha = i2, this._stateTracker.invalidateBlending());
  }
  setBlendEquation(t7) {
  ...
  setBlendEquationSeparate(t7, e7) {
    this._state.blendEquation.mode === t7 && this._state.blendEquation.modeAlpha === e7 || (this.gl.blendEquationSeparate(t7, e7), this._state.blendEquation.mode = t7, this._state.blendEquation.modeAlpha = e7, this._stateTracker.invalidateBlending());
  }
  setColorMask(t7, e7, s4, i2) {
    this._state.colorMask.r === t7 && this._state.colorMask.g === e7 && this._state.colorMask.b === s4 && this._state.colorMask.a === i2 || (this.gl.colorMask(t7, e7, s4, i2), this._state.colorMask.r = t7, this._state.colorMask.g = e7, this._state.colorMask.b = s4, this._state.colorMask.a = i2, this._stateTracker.invalidateColorWrite());
  }
  setClearColor(t7, e7, s4, i2) {
    this._state.clearColor.r === t7 && this._state.clearColor.g === e7 && this._state.clearColor.b === s4 && this._state.clearColor.a === i2 || (this.gl.clearColor(t7, e7, s4, i2), this._state.clearColor.r = t7, this._state.clearColor.g = e7, this._state.clearColor.b = s4, this._state.clearColor.a = i2);
  }
  ...
  setPolygonOffset(t7, e7) {
    this._state.polygonOffset[0] === t7 && this._state.polygonOffset[1] === e7 || (this._state.polygonOffset[0] = t7, this._state.polygonOffset[1] = e7, this.gl.polygonOffset(t7, e7), this._stateTracker.invalidatePolygonOffset());
  }
  setCullFace(t7) {
  ...
  setScissorRect(t7, e7, s4, i2) {
    this._state.scissorRect.x === t7 && this._state.scissorRect.y === e7 && this._state.scissorRect.width === s4 && this._state.scissorRect.height === i2 || (this.gl.scissor(t7, e7, s4, i2), this._state.scissorRect.x = t7, this._state.scissorRect.y = e7, this._state.scissorRect.width = s4, this._state.scissorRect.height = i2);
  }
  ...
  setDepthRange(t7, e7) {
    this._state.depthRange.zNear === t7 && this._state.depthRange.zFar === e7 || (this.gl.depthRange(t7, e7), this._state.depthRange.zNear = t7, this._state.depthRange.zFar = e7, this._stateTracker.invalidateDepthWrite());
  }
  ...
  setStencilFunction(t7, e7, s4) {
    this._state.stencilFunction.func === t7 && this._state.stencilFunction.ref === e7 && this._state.stencilFunction.mask === s4 || (this.gl.stencilFunc(t7, e7, s4), this._state.stencilFunction.face = N.FRONT_AND_BACK, this._state.stencilFunction.func = t7, this._state.stencilFunction.ref = e7, this._state.stencilFunction.mask = s4, this._stateTracker.invalidateStencilTest());
  }
  setStencilFunctionSeparate(t7, e7, s4, i2) {
    this._state.stencilFunction.face === t7 && this._state.stencilFunction.func === e7 && this._state.stencilFunction.ref === s4 && this._state.stencilFunction.mask === i2 || (this.gl.stencilFuncSeparate(t7, e7, s4, i2), this._state.stencilFunction.face = t7, this._state.stencilFunction.func = e7, this._state.stencilFunction.ref = s4, this._state.stencilFunction.mask = i2, this._stateTracker.invalidateStencilTest());
  }
  ...
  setStencilOp(t7, e7, s4) {
    this._state.stencilOperation.face === N.FRONT_AND_BACK && this._state.stencilOperation.fail === t7 && this._state.stencilOperation.zFail === e7 && this._state.stencilOperation.zPass === s4 || (this.gl.stencilOp(t7, e7, s4), this._state.stencilOperation.face = N.FRONT_AND_BACK, this._state.stencilOperation.fail = t7, this._state.stencilOperation.zFail = e7, this._state.stencilOperation.zPass = s4, this._stateTracker.invalidateStencilTest());
  }
  setStencilOpSeparate(t7, e7, s4, i2) {
    this._state.stencilOperation.face === t7 && this._state.stencilOperation.fail === e7 && this._state.stencilOperation.zFail === s4 && this._state.stencilOperation.zPass === i2 || (this.gl.stencilOpSeparate(t7, e7, s4, i2), this._state.stencilOperation.face = t7, this._state.stencilOperation.fail = e7, this._state.stencilOperation.zFail = s4, this._state.stencilOperation.zPass = i2, this._stateTracker.invalidateStencilTest());
  }
  setActiveTexture(t7, e7 = false) {
    const s4 = this._state.activeTexture;
    return t7 >= 0 && (e7 || t7 !== this._state.activeTexture) && (this.gl.activeTexture(Y + t7), this._state.activeTexture = t7), s4;
  }
  clear(t7) {
    t7 && this.gl.clear(t7);
  }
  clearSafe(t7, e7 = 255) {
    t7 && (t7 & _.COLOR_BUFFER_BIT && this.setColorMask(true, true, true, true), t7 & _.DEPTH_BUFFER_BIT && this.setDepthWriteEnabled(true), t7 & _.STENCIL_BUFFER_BIT && this.setStencilWriteMask(e7), this.gl.clear(t7));
  }
  drawArrays(t7, e7, s4) {
    if (a() && (this._numOfDrawCalls++, this._numOfTriangles += N2(t7, s4)), this.gl.drawArrays(t7, e7, s4), a()) {
      const t8 = a2(this);
      t8 && console.error("drawArrays:", t8);
    }
  }
  drawElements(t7, e7, s4, a3) {
    if (a() && (this._numOfDrawCalls++, this._numOfTriangles += N2(t7, e7)), this.gl.drawElements(t7, e7, s4, a3), a()) {
      const i2 = a2(this);
      if (i2) {
        const r6 = this.getBoundVAO(), n7 = r6 == null ? void 0 : r6.indexBuffer, l2 = r6 == null ? void 0 : r6.vertexBuffers, h3 = { indexBuffer: n7, vertexBuffers: l2 }, f2 = { mode: t7, count: e7, type: s4, offset: a3 }, o4 = (n7 == null ? void 0 : n7.size) ?? 0, u2 = a3 + e7, c2 = o4 < u2 ? `. Buffer is too small. Attempted to draw index ${u2} of ${o4}` : "";
  ...
  setViewport(t7, e7, s4, i2) {
    s4 = Math.max(Math.round(s4), 1), i2 = Math.max(Math.round(i2), 1);
    const a3 = this._state.viewport;
    a3.x === t7 && a3.y === e7 && a3.width === s4 && a3.height === i2 || (a3.x = t7, a3.y = e7, a3.width = s4, a3.height = i2, this.gl.viewport(t7, e7, s4, i2));
  }
  getViewport() {
  ...
  bindTexture(t7, e7, s4 = false) {
    ...
    return null == t7 || null == t7.glName ? (null != i2 && (this.setActiveTexture(e7, s4), this.gl.bindTexture(i2.descriptor.target, null)), this._state.textureUnitMap[e7] = null, i2) : s4 || i2 !== t7 ? (this.setActiveTexture(e7, s4), this.gl.bindTexture(t7.descriptor.target, t7.glName), t7.applyChanges(), this._state.textureUnitMap[e7] = t7, i2) : (t7.isDirty && (this.setActiveTexture(e7, s4), t7.applyChanges()), i2);
  }
  unbindTexture(t7) {
    if (null != t7)
      for (let e7 = 0; e7 < this.parameters.maxTextureImageUnits; e7++)
        this._state.textureUnitMap[e7] === t7 && (this.bindTexture(null, e7), this._state.textureUnitMap[e7] = null);
  }
  bindFramebuffer(t7, e7 = false) {
    if (e7 || this._state.readFramebuffer !== t7 || this._state.drawFramebuffer !== t7) {
      if (null == t7)
  ...
  bindFramebufferSeparate(t7, e7, s4 = false) {
    const i2 = e7 === n2.READ_FRAMEBUFFER, a3 = i2 ? this._state.readFramebuffer : this._state.drawFramebuffer;
    (s4 || a3 !== t7) && (null == t7 ? this.gl.bindFramebuffer(e7, null) : t7.initializeAndBind(e7), i2 ? this._state.readFramebuffer = t7 ?? null : this._state.drawFramebuffer = t7 ?? null);
  }
  blitFramebuffer(t7, e7, s4 = 0, i2 = 0, a3 = t7.width, r6 = t7.height, n7 = 0, l2 = 0, h3 = e7.width, c2 = e7.height, _3 = _.COLOR_BUFFER_BIT, d3 = L.NEAREST) {
    this.bindFramebufferSeparate(t7, n2.READ_FRAMEBUFFER), this.bindFramebufferSeparate(e7, n2.DRAW_FRAMEBUFFER);
    this.gl.blitFramebuffer(s4, i2, a3, r6, n7, l2, h3, c2, _3, d3);
  }
  bindBuffer(t7, e7) {
    if (t7)
      switch (e7 ?? (e7 = t7.bufferType), e7) {
        case A.ARRAY_BUFFER:
          this._state.vertexBuffer = v(this.gl, t7, e7, this._state.vertexBuffer);
          break;
        case A.ELEMENT_ARRAY_BUFFER:
          this._state.indexBuffer = v(this.gl, t7, e7, this._state.indexBuffer);
          break;
        case A.UNIFORM_BUFFER:
          this._state.uniformBuffer = v(this.gl, t7, e7, this._state.uniformBuffer);
          break;
        case A.PIXEL_PACK_BUFFER:
          this._state.pixelPackBuffer = v(this.gl, t7, e7, this._state.pixelPackBuffer);
          break;
        case A.PIXEL_UNPACK_BUFFER:
          this._state.pixelUnpackBuffer = v(this.gl, t7, e7, this._state.pixelUnpackBuffer);
          break;
        case A.COPY_READ_BUFFER:
          this._state.copyReadBuffer = v(this.gl, t7, e7, this._state.copyReadBuffer);
          break;
        case A.COPY_WRITE_BUFFER:
          this._state.copyWriteBuffer = v(this.gl, t7, e7, this._state.copyWriteBuffer);
      }
  }
  bindRenderbuffer(t7) {
    const e7 = this.gl;
    t7 || (e7.bindRenderbuffer(e7.RENDERBUFFER, null), this._state.renderbuffer = null), this._state.renderbuffer !== t7 && (e7.bindRenderbuffer(e7.RENDERBUFFER, t7.glName), this._state.renderbuffer = t7);
  }
  _getBufferBinding(t7, e7) {
    if (e7 >= this.parameters.maxUniformBufferBindings || e7 < 0)
      return console.error("Uniform buffer binding point is out of range!"), null;
    const s4 = this._state.uniformBufferBindingPoints;
    let i2 = s4[e7];
    return null == i2 && (i2 = { buffer: null, offset: 0, size: 0 }, s4[e7] = i2), i2;
  }
  bindBufferBase(t7, e7, s4) {
    const i2 = this._getBufferBinding(t7, e7);
    if (null == i2)
      return;
    if (i2.buffer === s4 && 0 === i2.offset && 0 === i2.size)
      return;
    this.gl.bindBufferBase(t7, e7, s4 ? s4.glName : null), i2.buffer = s4, i2.offset = 0, i2.size = 0;
  }
  bindBufferRange(t7, e7, s4, i2, a3) {
    const r6 = this._getBufferBinding(t7, e7);
    if (null == r6)
      return;
    if (r6.buffer === s4 && r6.offset === i2 && r6.size === a3)
      return;
    ...
    this.gl.bindBufferRange(t7, e7, s4.glName, i2, a3), r6.buffer = s4, r6.offset = i2, r6.size = a3;
  }
  bindUBO(t7, e7, s4, a3) {
    null != e7 ? (a() && (a3 ?? e7.byteLength) > this._parameters.maxUniformBlockSize && console.error("Attempting to bind more data than the maximum uniform block size"), e7.initialize(), void 0 !== s4 && void 0 !== a3 ? this.bindBufferRange(A.UNIFORM_BUFFER, t7, e7.buffer, s4, a3) : this.bindBufferBase(A.UNIFORM_BUFFER, t7, e7.buffer)) : this.bindBufferBase(A.UNIFORM_BUFFER, t7, null);
  }
  unbindUBO(t7) {
    for (let e7 = 0, s4 = this._state.uniformBufferBindingPoints.length; e7 < s4; e7++) {
      const s5 = this._state.uniformBufferBindingPoints[e7];
      null != s5 && s5.buffer === t7.buffer && this.bindBufferBase(A.UNIFORM_BUFFER, e7, null);
    }
  }
  unbindBuffer(t7) {
    switch (t7) {
  ...
  enforceState() {
    ...
    const { gl: e7, gl2: s4 } = this;
    for (let a3 = 0; a3 < this.parameters.maxVertexAttributes; a3++)
      e7.disableVertexAttribArray(a3);
    if (this._state.vertexBuffer ? e7.bindBuffer(this._state.vertexBuffer.bufferType, this._state.vertexBuffer.glName) : e7.bindBuffer(A.ARRAY_BUFFER, null), this._state.indexBuffer ? e7.bindBuffer(this._state.indexBuffer.bufferType, this._state.indexBuffer.glName) : e7.bindBuffer(A.ELEMENT_ARRAY_BUFFER, null), null != s4) {
      this._state.uniformBuffer ? s4.bindBuffer(this._state.uniformBuffer.bufferType, this._state.uniformBuffer.glName) : s4.bindBuffer(A.UNIFORM_BUFFER, null);
      for (let t8 = 0; t8 < this._parameters.maxUniformBufferBindings; t8++) {
        const e8 = this._state.uniformBufferBindingPoints[t8];
        if (null != e8) {
          const { buffer: i3, offset: a3, size: r6 } = e8;
          null !== i3 ? 0 === a3 && 0 === r6 ? s4.bindBufferBase(A.UNIFORM_BUFFER, t8, i3.glName) : s4.bindBufferRange(A.UNIFORM_BUFFER, t8, i3.glName, a3, r6) : s4.bindBufferBase(A.UNIFORM_BUFFER, t8, null);
        }
      }
      this._state.pixelPackBuffer ? s4.bindBuffer(this._state.pixelPackBuffer.bufferType, this._state.pixelPackBuffer.glName) : s4.bindBuffer(A.PIXEL_PACK_BUFFER, null), this._state.pixelUnpackBuffer ? s4.bindBuffer(this._state.pixelUnpackBuffer.bufferType, this._state.pixelUnpackBuffer.glName) : s4.bindBuffer(A.PIXEL_UNPACK_BUFFER, null), this._state.copyReadBuffer ? s4.bindBuffer(this._state.copyReadBuffer.bufferType, this._state.copyReadBuffer.glName) : s4.bindBuffer(A.COPY_READ_BUFFER, null), this._state.copyWriteBuffer ? s4.bindBuffer(this._state.copyWriteBuffer.bufferType, this._state.copyWriteBuffer.glName) : s4.bindBuffer(A.COPY_WRITE_BUFFER, null), s4.bindFramebuffer(n2.READ_FRAMEBUFFER, null), s4.readBuffer(s4.BACK), this._state.readFramebuffer && (s4.bindFramebuffer(n2.READ_FRAMEBUFFER, this._state.readFramebuffer.glName), s4.readBuffer(X.COLOR_ATTACHMENT0)), s4.bindFramebuffer(n2.DRAW_FRAMEBUFFER, ((_a = this._state.drawFramebuffer) == null ? void 0 : _a.glName) ?? null);
    } else
      this._state.readFramebuffer = this._state.drawFramebuffer, e7.bindFramebuffer(n2.FRAMEBUFFER, ((_b = this._state.drawFramebuffer) == null ? void 0 : _b.glName) ?? null);
    ...
    e7.useProgram(((_c = this._state.program) == null ? void 0 : _c.glName) ?? null), e7.blendColor(this._state.blendColor.r, this._state.blendColor.g, this._state.blendColor.b, this._state.blendColor.a), e7.bindRenderbuffer(e7.RENDERBUFFER, this._state.renderbuffer ? this._state.renderbuffer.glName : null), true === this._state.blend ? e7.enable(this.gl.BLEND) : e7.disable(this.gl.BLEND), e7.blendEquationSeparate(this._state.blendEquation.mode, this._state.blendEquation.modeAlpha), e7.blendFuncSeparate(this._state.blendFunction.srcRGB, this._state.blendFunction.dstRGB, this._state.blendFunction.srcAlpha, this._state.blendFunction.dstAlpha), e7.clearColor(this._state.clearColor.r, this._state.clearColor.g, this._state.clearColor.b, this._state.clearColor.a), e7.clearDepth(this._state.clearDepth), e7.clearStencil(this._state.clearStencil), e7.colorMask(this._state.colorMask.r, this._state.colorMask.g, this._state.colorMask.b, this._state.colorMask.a), e7.cullFace(this._state.cullFace), e7.depthFunc(this._state.depthFunction), e7.depthRange(this._state.depthRange.zNear, this._state.depthRange.zFar), true === this._state.depthTest ? e7.enable(e7.DEPTH_TEST) : e7.disable(e7.DEPTH_TEST), e7.depthMask(this._state.depthWrite), e7.frontFace(this._state.frontFace), e7.lineWidth(1), true === this._state.faceCulling ? e7.enable(e7.CULL_FACE) : e7.disable(e7.CULL_FACE), e7.polygonOffset(this._state.polygonOffset[0], this._state.polygonOffset[1]), true === this._state.polygonOffsetFill ? e7.enable(e7.POLYGON_OFFSET_FILL) : e7.disable(e7.POLYGON_OFFSET_FILL), e7.scissor(this._state.scissorRect.x, this._state.scissorRect.y, this._state.scissorRect.width, this._state.scissorRect.height), true === this._state.scissorTest ? e7.enable(e7.SCISSOR_TEST) : e7.disable(e7.SCISSOR_TEST), e7.stencilFunc(this._state.stencilFunction.func, this._state.stencilFunction.ref, this._state.stencilFunction.mask), e7.stencilOpSeparate(this._state.stencilOperation.face, this._state.stencilOperation.fail, this._state.stencilOperation.zFail, this._state.stencilOperation.zPass), true === this._state.stencilTest ? e7.enable(e7.STENCIL_TEST) : e7.disable(e7.STENCIL_TEST), e7.stencilMask(this._state.stencilWriteMask);
    for (let a3 = 0; a3 < this.parameters.maxTextureImageUnits; a3++) {
      e7.activeTexture(Y + a3), e7.bindTexture(M.TEXTURE_2D, null), e7.bindTexture(M.TEXTURE_CUBE_MAP, null), this.type === n3.WEBGL2 && (e7.bindTexture(M.TEXTURE_3D, null), e7.bindTexture(M.TEXTURE_2D_ARRAY, null));
      const t8 = this._state.textureUnitMap[a3];
      null != t8 && e7.bindTexture(t8.descriptor.target, t8.glName);
    }
    e7.activeTexture(Y + this._state.activeTexture);
    const i2 = this._state.viewport;
    e7.viewport(i2.x, i2.y, i2.width, i2.height), this.resetInfo();
  }
  _loadExtensions() {
    this.type === n3.WEBGL1 && this.gl.getExtension("OES_element_index_uint"), this.gl.getExtension("KHR_parallel_shader_compile");
  }
};
function v(t7, e7, s4, i2) {
  return e7 ? i2 !== e7 && t7.bindBuffer(s4, e7.glName) : t7.bindBuffer(s4, null), e7;
}
function N2(t7, e7) {
  switch (t7) {
    case E.POINTS:
...
//# sourceMappingURL=chunk-QQ4DNBSC.js.map
