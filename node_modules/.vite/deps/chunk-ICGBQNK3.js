...
e([y({ type: x, json: { write: { isRequired: true } } })], u.prototype, "position", void 0), e([r2("position")], u.prototype, "writePosition", null), e([o("position")], u.prototype, "readPosition", null), e([y({ type: Number, nonNullable: true, json: { write: { isRequired: true } } }), s2((o4) => s.normalize(a(o4)))], u.prototype, "heading", void 0), e([y({ type: Number, nonNullable: true, json: { write: { isRequired: true } } }), s2((o4) => i2(a(o4), -180, 180))], u.prototype, "tilt", void 0), e([y({ type: Number, nonNullable: true, json: { read: false, write: false } })], u.prototype, "fov", void 0), u = e([a2("esri.Camera")], u);
var d2 = u;
...
function nt(t2) {
  return null != t2 && s3(t2.spatialReference) ? 1 / (B(t2.spatialReference) * E * C2) : 1;
}
function rt(t2) {
  return r(t2.rotation) || 0;
}
function ot(t2) {
  return s3(t2) ? B(t2) * E * C2 : 1;
}
function at(t2, e4) {
  return l2(t2, e4, 0.5);
}
...
var dt = function() {
  ...
  return function(n5, r7, o4, a4, i4, c2, s5) {
    return _(e4, c2, s5), s4(t2, i4, e4), a4 ? wt(n5, r7, o4, a4, t2, c2) : ht(n5, r7, o4, t2, c2);
  };
}();
var jt = function() {
  const t2 = e3();
...
//# sourceMappingURL=chunk-ICGBQNK3.js.map
