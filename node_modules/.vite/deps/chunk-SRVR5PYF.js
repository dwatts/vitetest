...
var a2 = class {
  ...
  async _createLabelArcadeComputedField(e) {
    const s3 = this._sourceInfo.spatialReference, t2 = this._sourceInfo.fieldsIndex, { createLabelFunction: i3 } = await import("./labelFormatUtils-7OOPFGIJ.js"), a3 = await i3(e.label, t2, s3);
    return { ...e, builder: a3 };
  }
...
//# sourceMappingURL=chunk-SRVR5PYF.js.map
