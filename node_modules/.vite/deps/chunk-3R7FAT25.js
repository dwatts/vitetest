...
function p(e2, n2) {
  ...
  const r3 = f(e2.prototype.itemType), t4 = f(n2.constructor.prototype.itemType);
  return r3 ? t4 ? r3 === t4 ? n2 : r3.prototype.isPrototypeOf(t4.prototype) ? new e2(n2) : (y(e2, n2), n2) : new e2(n2) : n2;
}
function y(e2, n2) {
...
function S(e2, n2) {
  ...
  for (const r3 in e2.typeMap) {
    ...
    t4[r3] = d(n3), o2.push(g(n3)), u2.push(r3);
  }
  ...
  return (n3) => {
    ...
    if (null == n3)
      return n3;
    const o3 = l2(n3) || e2.defaultKeyValue, u3 = t4[o3];
    if (!u3)
...
function C(e2) {
  let n2 = null;
  return (t4, o2) => F(t4, e2) ? t4 : (null == n2 && (n2 = D(e2)), r2.error("Accessor#set", `Invalid property value, value needs to be of type ${n2}`), o2 && (o2.valid = false), null);
}
function D(e2) {
  switch (e2.type) {
    case "native":
...
var e = class _e {
  constructor(t4, i3, e2, o2 = 1, s3 = 0) {
    if (this._ctor = t4, this._acquireFunction = i3, this._releaseFunction = e2, this.allocationSize = o2, this._pool = new Array(s3), this._initialSize = s3, this._ctor)
  ...
  acquire(...t4) {
    ...
    return this._acquireFunction ? this._acquireFunction(o2, ...t4) : i2(o2) && o2.acquire(...t4), o2;
  }
  release(i3) {
    i3 && !_e.test.disabled && (this._releaseFunction ? this._releaseFunction(i3) : t3(i3) && i3.release(), this._pool.push(i3));
  }
...
//# sourceMappingURL=chunk-3R7FAT25.js.map
