...
} from "./chunk-AORFFYHL.js";
import {
  connectInteractive,
  defineCustomElement as defineCustomElement2,
  disconnectInteractive,
  updateHostInteraction
} from "./chunk-IISCA4CQ.js";
import "./chunk-A3VYJASA.js";
import {
  componentLoaded,
  connectLocalized,
  connectMessages,
  ...
  setUpMessages,
  updateMessages
} from "./chunk-OFXIHQZZ.js";
import {
  defineCustomElement
} from "./chunk-UKOOZRVA.js";
import "./chunk-XWT5MHZL.js";
import {
  getElementDir,
...
var ListItem = proxyCustomElement(class extends H {
  ...
  renderSelected() {
    ...
    return h("td", { class: CSS.selectionContainer, key: "selection-container", onClick: this.itemClicked }, h("calcite-icon", { icon: selected ? selectionMode === "multiple" ? ICONS.selectedMultiple : ICONS.selectedSingle : ICONS.unselected, scale: "s" }));
  }
  renderOpen() {
    const { el, open, openable, parentListEl } = this;
    const dir = getElementDir(el);
    return openable ? h("td", { class: CSS.openContainer, key: "open-container", onClick: this.toggleOpen }, h("calcite-icon", { icon: open ? ICONS.open : dir === "rtl" ? ICONS.closedRTL : ICONS.closedLTR, scale: "s" })) : (parentListEl == null ? void 0 : parentListEl.openable) ? h("td", { class: CSS.openContainer, key: "open-container", onClick: this.itemClicked }, h("calcite-icon", { icon: ICONS.blank, scale: "s" })) : null;
  }
  renderActionsStart() {
    ...
    }, h("slot", { name: SLOTS.actionsStart, onSlotchange: this.handleActionsStartSlotChange }));
  }
  renderActionsEnd() {
    ...
    }, h("slot", { name: SLOTS.actionsEnd, onSlotchange: this.handleActionsEndSlotChange }), closable ? h("calcite-action", { appearance: "transparent", icon: ICONS.close, key: "close-action", label: messages.close, onClick: this.closeClickHandler, text: messages.close }) : null);
  }
  renderContentStart() {
  ...
  render() {
    ...
    }, this.renderSelected(), this.renderOpen(), this.renderActionsStart(), this.renderContentContainer(), this.renderActionsEnd()), h("div", { class: {
...
@esri/calcite-components/dist/components/calcite-list-item.js:
   ...
   *)
*/
//# sourceMappingURL=calcite-list-item-VTHBHRFK.js.map
