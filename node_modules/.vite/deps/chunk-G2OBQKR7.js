...
e([y2({ type: Boolean })], p2.prototype, "isAggregate", void 0), p2 = e([a2("esri.AggregateGraphic")], p2);
var s3 = p2;
...
var c4 = class extends m2 {
  ...
  _transitionTo(e5) {
    const t5 = this._get("featureEffect"), i8 = e5, s6 = i8 == null ? void 0 : i8.includedEffect, f6 = i8 == null ? void 0 : i8.excludedEffect, c10 = this._includedEffectView.canTransitionTo(s6) && this._excludedEffectView.canTransitionTo(f6);
    this._includedEffectView.effect = s6, this._excludedEffectView.effect = f6, this._set("featureEffect", i8), this._filter = (i8 == null ? void 0 : i8.filter) || (t5 == null ? void 0 : t5.filter) || null, c10 || this.endTransitions();
  }
};
...
var c5 = class extends d3 {
  ...
  readFeatures(e5, t5) {
    const o9 = f.fromJSON(t5.spatialReference), s6 = [];
    for (let a10 = 0; a10 < e5.length; a10++) {
      const t6 = e5[a10], p6 = s3.fromJSON(t6), c10 = t6.geometry && t6.geometry.spatialReference;
      null == p6.geometry || c10 || (p6.geometry.spatialReference = o9);
      const i8 = t6.aggregateGeometries, m6 = p6.aggregateGeometries;
      if (i8 && null != m6)
        for (const e6 in m6) {
...
var i5 = class {
  ...
  render(i8) {
    l3(i8, 512, this.intensities, this.gradient, this.minDensity, this.maxDensity);
  }
};
...
var o5 = class extends o4 {
  constructor(e5) {
    ...
    } }, this._container = new n6(e5.tileInfoView);
  }
  createTile(e5) {
  ...
  onTileData(e5) {
    ...
    o9.intensities = i8 && i8.matrix || null, o9.minDensity = r8, o9.maxDensity = s6, o9.gradient = this._gradient, t5.bitmap.source = o9, this._container.addChild(t5), this._container.requestRender(), this.requestUpdate();
  }
  onTileError(e5) {
    console.error(e5);
  }
...
o5 = e([a2("esri.views.2d.layers.features.tileRenderers.HeatmapTileRenderer")], o5);
...
var a6 = u6 << 16 | u6;
var d7 = class {
  constructor(t5, i8, r8, s6) {
    const h5 = r.create(i8 * r8 * Uint32Array.BYTES_PER_ELEMENT, s6);
    this.size = i8, this.strideInt = r8, this.bufferType = t5, this.dirty = { start: 1 / 0, end: 0 }, this._gpu = null, this._cpu = h5, this.clear();
  }
  get elementSize() {
  ...
  clear() {
    ...
    if (t5 * this.strideInt > this._cpu.length - this.fillPointer) {
      this.invalidate();
      const i8 = this._cpu.length / this.strideInt, e5 = Math.round((i8 + t5) * n7), r8 = e5 * this.strideInt;
  ...
  insert(t5, e5, r8, s6) {
    ...
    if (!h5)
      return 0;
    const n9 = e5 * this.strideInt * Uint32Array.BYTES_PER_ELEMENT, u10 = new Uint32Array(t5, n9, h5), a10 = u(this.freeList.firstFit(r8), "First fit region must be defined") * this.strideInt, d11 = h5, f6 = a10 / this.strideInt - e5;
    if (0 !== s6)
      for (let i8 = 0; i8 < u10.length; i8++)
        u10[i8] += s6;
    return this._cpu.array.set(u10, a10), this.dirty.start = Math.min(this.dirty.start, a10), this.dirty.end = Math.max(this.dirty.end, a10 + d11), this.fillPointer = Math.max(this.fillPointer, a10 + d11), f6;
  }
  free(t5, i8, e5) {
    const r8 = t5 * this.strideInt, s6 = (t5 + i8) * this.strideInt;
    if (true === e5)
      for (let h5 = t5; h5 !== t5 + i8; h5++)
        this._cpu.array[h5 * this.strideInt] = a6;
  ...
  _createBuffer(t5) {
    ...
    return "index" === this.bufferType ? c3.createIndex(t5, i8, this._cpu.array) : c3.createVertex(t5, i8, this._cpu.array);
  }
  _createComputeBuffer(t5) {
    ...
    return c3.createIndex(t5, i8, e5);
  }
};
...
var d8 = class {
  ...
  insert(e5, r8, n9) {
    ...
    if (this._vertexBuffer && this._indexBuffer) {
      const s6 = e5.indices.byteLength / 4, n10 = e5.vertices.byteLength / f6;
      this._indexBuffer.ensure(s6), this._vertexBuffer.ensure(n10);
      const { vertices: o9, indices: d11 } = e5, h5 = r2.from(e5.records), u10 = this._vertexBuffer.insert(o9, 0, o9.byteLength / f6, 0), c10 = this._indexBuffer.insert(d11, 0, d11.byteLength / 4, u10);
      if (h5.forEach((e6) => {
      ...
      const t5 = e5.indices.byteLength / 4, n10 = e5.vertices.byteLength / f6, o9 = f6 / Uint32Array.BYTES_PER_ELEMENT, d11 = this._stage.bufferPool;
      this._records = r2.from(e5.records), this._indexBuffer = new d7("index", t5, 1, d11), this._vertexBuffer = new d7("vertex", n10, o9, d11), this._indexBuffer.insert(e5.indices, 0, e5.indices.byteLength / 4, 0), this._vertexBuffer.insert(e5.vertices, 0, e5.vertices.byteLength / f6, 0), r8 && (this._indicesInvalid = true);
    }
  }
  remove(e5) {
    if (null != this._records)
      for (const t5 of e5) {
        ...
        let i8 = e6.indexCount, n9 = e6.vertexCount;
        for (; e6.next() && e6.id === t5; )
          i8 += e6.indexCount, n9 += e6.vertexCount;
        this._indexBuffer.free(r8, i8), this._vertexBuffer.free(s6, n9, true), this._records.delete(t5);
      }
  }
  getVAO(e5, t5, r8, s6) {
    ...
    const h5 = this._indexBuffer.getGPUBuffer(e5, 1 === i8), u10 = this._vertexBuffer.getGPUBuffer(e5);
    return d11 || (d11 = new u5(e5, r8, t5, { geometry: u10 }, h5), this._vaos.set(i8, d11)), d11;
  }
  forEachCommand(e5) {
    if (null != this._records) {
      if (this._sortIndices(this._records), !this._displayList) {
        const e6 = this._cursorIndexOrder;
        this._displayList = n4.from(this, this.geometryType, this._records.getCursor(), e6);
      }
  ...
  _sortIndices(e5) {
    ...
    let r8 = 0;
    const s6 = e5.getCursor(), i8 = [], n9 = [], f6 = [];
    for (; s6.next(); )
      n9.push(s6.index), f6.push(s6.sortKey), i8.push(s6.id);
    n9.sort((e6, t6) => {
      const r9 = f6[t6], s7 = f6[e6];
      return s7 === r9 ? i8[t6] - i8[e6] : r9 - s7;
    });
    const o9 = e5.getCursor(), d11 = t5 ? this._indexBuffer.getCPUBuffer() : this._vertexBuffer.getCPUBuffer();
    for (const h5 of n9) {
      if (!o9.seekIndex(h5))
      ...
      if (t5) {
        ...
        const { vertexFrom: e6, vertexCount: t6 } = o9, s7 = this._vertexBuffer.strideInt, i9 = e6 * s7, n10 = i9 + t6 * s7;
        o9.vertexFrom = r8 / s7;
        for (let f7 = i9; f7 < n10; f7++)
          this._vertexBuffer.set(r8++, d11.array[f7]);
      }
    }
    this._cursorIndexOrder = n9, this._displayList = null;
  }
};
...
var c6 = class extends m4 {
  constructor(r8, s6, i8, a10, n9, h5) {
    super(r8, s6, i8, a10), this.instanceId = u7++, this.patchCount = 0, this._renderState = { current: { geometry: /* @__PURE__ */ new Map(), metrics: null }, next: null, swap: false, swapFrames: 0, locked: false }, this._patches = new t(o7), this._bufferPatches = new t(o7), this._lastCommitTime = 0, this.transforms.labelMat2d = n2(), this._store = n9, this._requestLabelUpdate = h5;
  }
  destroy() {
  ...
  _insert(e5, t5, s6) {
    var _a, _b;
    try {
      const i8 = this._renderState.next ?? this._renderState.current, a10 = (_a = t5.addOrUpdate) == null ? void 0 : _a.data[e5], h5 = i8.geometry;
      if (null == a10)
        return;
      h5.has(e5) || (has("esri-2d-update-debug") && console.debug(this.key.id, `FeatureTile:_insert - Creating geometry buffer ${e5}`), h5.set(e5, new d8(e5, this.stage))), has("esri-2d-update-debug") && console.debug(this.key.id, `FeatureTile:_insert - Inserting into ${e5}, version=${(_b = t5.addOrUpdate) == null ? void 0 : _b.version} stride=${a10.stride}`), h5.get(e5).insert(a10, t5.sort, s6), e5 === E2.LABEL && this._insertLabelMetrics(t5.type, a10.metrics, t5.clear);
    } catch (i8) {
    }
  }
...
var a7 = class extends o3 {
  ...
  onTileData(e5, t5) {
    const s6 = r6 && "orderBy" in this._layer && this._layer.orderBy, i8 = s6 && (s6 == null ? void 0 : s6.length) && !s6[0].valueExpression && s6[0].field, a10 = !!s6 && this._layerView.orderByFields === i8;
    e5.patch(t5, a10), this.contains(e5) || this.addChild(e5), this.requestRender();
  }
  onTileError(e5) {
  ...
  prepareRenderPasses(e5) {
    const s6 = super.prepareRenderPasses(e5), r8 = e5.registerRenderPass({ name: "label", brushes: [w2.label], target: () => this.hasLabels ? this.children : null, drawPhase: T.LABEL | T.LABEL_ALPHA });
    if (has("featurelayer-force-marker-text-draw-order")) {
      const i8 = e5.registerRenderPass({ name: "geometry", brushes: [w2.fill, w2.dotDensity, w2.line, w2.heatmap, w2.pieChart], target: () => this.children, forceDrawByDisplayOrder: true, enableDefaultDraw: () => !this._layerView.featureEffectView.hasEffects, effects: [{ apply: e5.effects.outsideEffect, enable: () => this._layerView.featureEffectView.hasEffects, args: () => this._layerView.featureEffectView.excludedEffects }, { apply: e5.effects.insideEffect, enable: () => this._layerView.featureEffectView.hasEffects, args: () => this._layerView.featureEffectView.includedEffects }, { apply: e5.effects.hittest, enable: () => !!this._hitTestsRequests.length, args: () => this._hitTestsRequests }] });
      s6.push(i8);
    } else {
      const i8 = e5.registerRenderPass({ name: "geometry", brushes: [w2.fill, w2.dotDensity, w2.line, w2.marker, w2.heatmap, w2.pieChart, w2.text], target: () => this.children, enableDefaultDraw: () => !this._layerView.featureEffectView.hasEffects, effects: [{ apply: e5.effects.outsideEffect, enable: () => this._layerView.featureEffectView.hasEffects, args: () => this._layerView.featureEffectView.excludedEffects }, { apply: e5.effects.insideEffect, enable: () => this._layerView.featureEffectView.hasEffects, args: () => this._layerView.featureEffectView.includedEffects }, { apply: e5.effects.hittest, enable: () => !!this._hitTestsRequests.length, args: () => this._hitTestsRequests }] });
      s6.push(i8);
    }
    const a10 = e5.registerRenderPass({ name: "highlight", brushes: [w2.fill, w2.dotDensity, w2.line, w2.marker, w2.pieChart, w2.text], target: () => this.children, drawPhase: T.HIGHLIGHT, enableDefaultDraw: () => false, effects: [{ apply: e5.effects.highlight, enable: () => !!this._layerView.hasHighlight() }] });
    return s6.push(a10), s6.push(r8), s6;
  }
};

// node_modules/@arcgis/core/views/2d/layers/features/tileRenderers/SymbolTileRenderer.js
var p3 = class extends o4 {
  constructor() {
    super(...arguments), this.type = "symbol";
  }
  install(e5) {
    const t5 = () => this.notifyChange("updating"), i8 = new a7(this.tileInfoView, this.layerView, this.layer, t5);
  ...
  fetchResource(e5, t5) {
    ...
    try {
      ...
      return d(a10) ? Promise.resolve({ width: 0, height: 0 }) : Promise.reject(a10);
    }
  }
  isUpdating() {
    var _a;
  ...
  onConfigUpdate(e5) {
    ...
    if (e5 && "visualVariables" in e5) {
      const i8 = (n5(e5).visualVariables || []).map((e6) => {
        const t6 = e6.clone();
  ...
  createTile(e5) {
    const t5 = this.tileInfoView.getTileBounds(i2(), e5), i8 = () => this.layerView.view.labelManager.requestUpdate(), r8 = this.tileInfoView.getTileResolution(e5.level), o9 = this.featuresView.attributeView;
    return new c6(e5, r8, t5[0], t5[3], o9, i8);
  }
  disposeTile(e5) {
    this.featuresView.removeChild(e5), e5.destroy(), this.layerView.view.labelManager.requestUpdate();
  }
};
p3 = e([a2("esri.views.2d.layers.features.tileRenderers.SymbolTileRenderer")], p3);
...
var c7 = class extends m2 {
  ...
  _mergeEdits(e5, t5) {
    ...
    const c10 = new Set(n8((e5 == null ? void 0 : e5.edits.addOrModified) ?? [])), p6 = new Set(n8((e5 == null ? void 0 : e5.edits.removed) ?? [])), u10 = /* @__PURE__ */ new Set([...n8(s6), ...n8(o9)]), l8 = new Set(n8(r8));
    return [{ type: "processed-edit", edits: { addOrModified: Array.from(d10(a8(c10, l8), u10)).map((e6) => ({ objectId: e6 })), removed: Array.from(d10(a8(p6, u10), l8)).map((e6) => ({ objectId: e6 })) } }];
  }
};
...
var u8 = class extends p {
  ...
  async startup(e5, t5, r8, s6) {
    await this.when();
    const o9 = this._controller.signal, i8 = c8(r8.source) ? { transferList: r8.source, signal: o9 } : void 0, n9 = { service: r8, config: t5, tileInfo: e5.tileInfo.toJSON(), tiles: s6 };
    await this._connection.invoke("startup", n9, i8), this._startupResolver.resolve(), this._set("isReady", true);
  }
  ...
  async _startWorker(e5) {
    try {
      this._connection = await f2("Pipeline", { client: this.client, strategy: "dedicated", signal: e5 });
    } catch (t5) {
      m(t5);
    }
  }
...
function s5(e5, t5) {
  return e5 + (a9(t5.minSize, e5) || t5.minDataValue);
}
function o8(e5, t5) {
  const n9 = e5.stops;
  let r8 = n9 && n9.length && n9[0].size;
  return null == r8 && (r8 = e5.minSize), a9(r8, t5);
}
function u9(e5, t5) {
  const n9 = t5.minDataValue, r8 = t5.maxDataValue, i8 = (e5 - n9) / (r8 - n9), s6 = a9(t5.minSize, e5), o9 = a9(t5.maxSize, e5);
  return e5 <= n9 ? s6 : e5 >= r8 ? o9 : s6 + i8 * (o9 - s6);
}
function l6(t5, n9) {
  const r8 = t5 / n9.minDataValue, i8 = a9(n9.minSize, t5), s6 = a9(n9.maxSize, t5);
  let o9 = null;
  return o9 = r8 * i8, i(o9, i8, s6);
}
function c9(e5, t5) {
  const [n9, r8, i8] = p5(e5, t5.cache.ipData);
  if (n9 === r8)
    return a9(t5.stops[n9].size, e5);
  {
    const s6 = a9(t5.stops[n9].size, e5);
    return s6 + (a9(t5.stops[r8].size, e5) - s6) * i8;
  }
}
function m5(n9, i8) {
  const s6 = m3[i8.valueUnit], o9 = a9(i8.minSize, n9), u10 = a9(i8.maxSize, n9), { valueRepresentation: l8 } = i8;
  let c10 = null;
  return c10 = "area" === l8 ? 2 * Math.sqrt(n9 / r7) / s6 : "radius" === l8 || "distance" === l8 ? 2 * n9 / s6 : n9 / s6, i(c10, o9, u10);
}
function p5(e5, t5) {
  if (!t5)
    return;
  let n9 = 0, r8 = t5.length - 1;
  return t5.some((t6, i8) => e5 < t6 ? (r8 = i8, true) : (n9 = i8, false)), [n9, r8, (e5 - t5[n9]) / (t5[r8] - t5[n9])];
}
...
var l7 = class {
  ...
  update(t5) {
    const l8 = this.tileInfoView.getTileCoverage(t5.state, this.buffer, true, "closest"), { spans: s6, lodInfo: r8 } = l8, { level: a10 } = r8, o9 = [], d11 = [], h5 = /* @__PURE__ */ new Set(), n9 = /* @__PURE__ */ new Set();
    for (const { row: e5, colFrom: c10, colTo: f6 } of s6)
      for (let t6 = c10; t6 <= f6; t6++) {
        const l9 = e2.getId(a10, e5, r8.normalizeCol(t6), r8.getWorldForColumn(t6)), s7 = this._getOrAcquireTile(o9, l9);
        h5.add(l9), s7.isReady ? s7.visible = true : n9.add(s7.key);
      }
    n9.forEach((e5) => this._addPlaceholders(h5, e5)), this._tiles.forEach((e5) => {
      h5.has(e5.key.id) || (d11.push(e5.key.id), this._releaseTile(e5));
    }), l4.pool.release(l8);
    return { hasMissingTiles: n9.size > 0, added: o9, removed: d11 };
  }
  ...
  _addPlaceholders(e5, i8) {
    const l8 = this._addPlaceholderChildren(e5, i8);
    if (!(Math.abs(1 - l8) < t4)) {
  ...
  _addPlaceholderChildren(e5, i8) {
    ...
    return this._tiles.forEach((l8) => {
      t5 += this._addPlaceholderChild(e5, l8, i8);
    }), t5;
  }
  ...
  _addPlaceholderParent(e5, i8) {
    let t5 = i8.getParentKey(), l8 = 0, s6 = null;
    for (; null != t5; ) {
      if (e5.has(t5.id))
        return true;
      ...
      (i9 == null ? void 0 : i9.hasData) && i9.patchCount > l8 && (l8 = i9.patchCount, s6 = i9), t5 = t5.getParentKey();
    }
...
var K = class extends _(a3(f4(d6))) {
  constructor() {
    super(...arguments), this._pipelineIsUpdating = true, this._commandsQueue = new p4({ process: (e5) => {
      switch (e5.type) {
        case "processed-edit":
  ...
  get labelingCollisionInfos() {
    ...
    if (null == e5)
      return null;
    const r8 = "subtype-group" === this.layer.type ? this.layer.sublayers.items : [this.layer], i8 = t5.geometryType, s6 = !B(r8), a10 = {};
    ...
    return [{ tileRenderer: e5, vvEvaluators: a10, deconflictionEnabled: s6, geometryType: i8, visible: !this.suspended }];
  }
  get queryMode() {
    var _a;
  ...
  get renderingConfigHash() {
    ...
    if (!this.layer)
      return null;
    const e5 = this.availableFields, t5 = this.layer, r8 = this.view.floors, { definitionExpression: i8 } = t5, s6 = "subtype-group" !== this.layer.type && this.layer.labelsVisible && this.layer.labelingInfo, a10 = "renderer" in t5 && t5.renderer, n9 = "gdbVersion" in t5 ? t5.gdbVersion : void 0, o9 = "historicMoment" in t5 ? (_a = t5.historicMoment) == null ? void 0 : _a.getTime() : void 0, { timeExtent: l8 } = this, u10 = "customParameters" in t5 ? JSON.stringify(t5.customParameters) : void 0, d11 = "apiKey" in t5 ? t5.apiKey : void 0, h5 = "stream" === t5.type ? `${JSON.stringify(t5.geometryDefinition)}${t5.definitionExpression}` : null, p6 = JSON.stringify(this.clips), c10 = (_b = this._effectiveFeatureReduction) == null ? void 0 : _b.toJSON(), y3 = "orderBy" in this.layer && JSON.stringify(this.layer.orderBy), g = "sublayers" in this.layer && this.layer.sublayers.items.reduce((e6, t6) => e6 + `${t6.visible ? 1 : 0}.${JSON.stringify(t6.renderer)}.${t6.labelsVisible}
.${JSON.stringify(t6.labelingInfo)}`, ""), f6 = "subtypeCode" in this.layer && this.layer.subtypeCode;
    return JSON.stringify({ orderBy: y3, sublayerHash: g, subtypeCode: f6, filterHash: null != this.filter && this.filter.toJSON(), effectHash: null != this.featureEffect && this.featureEffect.toJSON(), streamFilter: h5, gdbVersion: n9, definitionExpression: i8, historicMoment: o9, availableFields: e5, renderer: a10, labelingInfo: s6, timeExtent: l8, floors: r8, clipsHash: p6, featureReduction: c10, customParameters: u10, apiKey: d11 });
  }
  highlight(e5) {
    let t5;
    ...
    const a10 = t5 == null ? void 0 : t5.filter(R);
    return a10 && a10.length ? (this._addHighlight(a10), { remove: () => this._removeHighlight(a10) }) : { remove: () => {
    } };
  }
  hasHighlight() {
  ...
  async hitTest(e5, i8) {
    ...
    const { features: a10, aggregates: n9 } = await this._proxy.getFeatures(s6);
    return [...n9.map((r8) => this._createGraphicHit(e5, s3.fromJSON(r8))), ...a10.map((t5) => this._createGraphicHit(e5, h2.fromJSON(t5)))];
  }
  queryStatistics() {
  ...
  isUpdating() {
    var _a;
    const e5 = "renderer" in this.layer && null != this.layer.renderer, t5 = this._commandsQueue.updating, r8 = null != this._updatingRequiredFieldsPromise, i8 = !this._proxy || !this._proxy.isReady, s6 = this._pipelineIsUpdating, a10 = null == this.tileRenderer || ((_a = this.tileRenderer) == null ? void 0 : _a.updating), n9 = e5 && (t5 || r8 || i8 || s6 || a10);
    return has("esri-2d-log-updating") && console.log(`Updating FLV2D (${this.layer.id}): ${n9}
  -> hasRenderer ${e5}
  -> hasPendingCommand ${t5}
  -> updatingRequiredFields ${r8}
  -> updatingProxy ${i8}
  -> updatingPipeline ${s6}
  -> updatingTileRenderer ${a10}
`), n9;
  }
  ...
  async _detectQueryMode(e5) {
    var _a;
    const t5 = "path" in e5, { layer: r8 } = this, i8 = "editingInfo" in r8 && ((_a = r8.editingInfo) == null ? void 0 : _a.lastEditDate), s6 = "refreshInterval" in r8 && !!r8.refreshInterval, a10 = !i8 && s6, n9 = E(r8);
    if (t5 && ("feature" === r8.type || "subtype-group" === r8.type) && "point" === r8.geometryType && (n9 == null ? void 0 : n9.query.supportsPagination) && !(n9 == null ? void 0 : n9.operations.supportsEditing) && !a10 && has("featurelayer-snapshot-enabled"))
      try {
        ...
        const t6 = has("featurelayer-snapshot-point-max-threshold"), i9 = has("featurelayer-snapshot-point-coverage"), s7 = this.view.extent, a11 = r8.fullExtent, n10 = a11 == null ? void 0 : a11.clone().intersection(s7), o9 = null != n10 ? n10.width * n10.height : 0, l8 = (a11 == null ? void 0 : a11.width) * (a11 == null ? void 0 : a11.height);
        if (e6 <= t6 && (0 === l8 ? 0 : o9 / l8) >= i9)
          return { mode: "snapshot", featureCount: e6 };
      } catch (l8) {
  ...
  async _createServiceOptions() {
    ...
    if ("stream" === e5.type)
      return null;
    const t5 = E(e5), { capabilities: r8, objectIdField: i8 } = e5, s6 = e5.fields.map((e6) => e6.toJSON()), a10 = null != e5.fullExtent ? e5.fullExtent.toJSON() : null, o9 = e3(e5.geometryType), l8 = "timeInfo" in e5 && e5.timeInfo && e5.timeInfo.toJSON() || null, u10 = e5.spatialReference ? e5.spatialReference.toJSON() : null, d11 = "feature" === e5.type ? e5.globalIdField : null;
    let h5;
    ...
    const p6 = "datesInUnknownTimezone" in this.layer && this.layer.datesInUnknownTimezone, c10 = ("subtypeField" in this.layer ? this.layer.subtypeField : null) ?? null, { mode: y3, featureCount: g } = await this._detectQueryMode(h5);
    ...
    return { type: y3, timeReferenceUnknownClient: p6, subtypeField: c10, featureCount: g, globalIdField: d11, maxRecordCount: r8.query.maxRecordCount, tileMaxRecordCount: r8.query.tileMaxRecordCount, capabilities: r8, effectiveCapabilities: t5, fields: s6, fullExtent: a10, geometryType: o9, objectIdField: i8, source: h5, timeInfo: l8, spatialReference: u10, orderByFields: f6, datesInUnknownTimezone: p6, dateFieldsTimeReference: ("dateFieldsTimeReference" in this.layer ? (_a = this.layer.dateFieldsTimeReference) == null ? void 0 : _a.toJSON() : null) || null, preferredTimeReference: ("preferredTimeReference" in this.layer ? (_b = this.layer.preferredTimeReference) == null ? void 0 : _b.toJSON() : null) || null, editFieldsInfo: "editFieldsInfo" in this.layer ? (_c = this.layer.editFieldsInfo) == null ? void 0 : _c.toJSON() : null };
  }
  ...
  async _doUpdate() {
    ...
    try {
      ...
      const s6 = this._createSchemaConfig(), a10 = this._createConfiguration(s6, r8, t5.filter), n9 = this._lastDefinitionExpression !== a10.schema.source.definitionExpression;
      this._lastDefinitionExpression = a10.schema.source.definitionExpression;
      const l8 = a10.schema.tileRenderer, u10 = this._createTileRendererHash(l8);
      if ("snapshot" === this._serviceOptions.type && (a10.schema.source.initialFeatureCount = this._serviceOptions.featureCount), u10 !== this._tileRendererHash) {
        this._initTileRenderer(l8, i8);
        const e5 = this.layer, t6 = "stream" === e5.type ? await this._initServiceOptions() : this._serviceOptions;
        this.tileRenderer.onConfigUpdate(i8), "stream" !== e5.type && M2(e5.source) && (t6.source = await e5.source.openPorts());
        const r9 = { added: this._tileStrategy.tileKeys(), removed: [] };
        has("esri-2d-update-debug") && console.debug("FeatureLayerView2D: Proxy startup"), await this._proxy.startup(this.view.featuresTilingScheme, a10, t6, r9), has("esri-2d-update-debug") && console.debug("FeatureLayerView2D: Finished proxy startup"), this.hasHighlight() && (has("esri-2d-update-debug") && console.debug("FeatureLayerView2D: Updating highlight"), await this._proxy.setHighlight(Array.from(this._highlightIds.keys())), has("esri-2d-update-debug") && console.debug("FeatureLayerView2D: Finished highlight update")), has("esri-2d-update-debug") && console.debug("FeatureLayerView2D: onConfigUpdate start"), this.tileRenderer.onConfigUpdate(i8), has("esri-2d-update-debug") && console.debug("FeatureLayerView2D: onConfigUpdate end");
      } else {
        "snapshot" === this._serviceOptions.type && n9 && (a10.schema.source.changedFeatureCount = await this.layer.queryFeatureCount()), has("esri-2d-update-debug") && console.debug("FeatureLayerView2D: Updating proxy");
        const t6 = await this._proxy.update(a10);
  ...
  async _updateClusterEffectiveRendererSizeVariable(e5, t5, r8) {
    if (e5.dynamicClusterSize && "visualVariables" in e5 && e5.visualVariables) {
      ...
      if (null != i8 && "cluster_count" === i8.field) {
        ...
        const a10 = e5.clone();
        a10.dynamicClusterSize = true, this._set("_effectiveRenderer", a10);
      }
    }
  }
  _getEffectiveRenderer() {
    ...
    if (r8 && "cluster" === r8.type && t5 && b2(t5)) {
      const e6 = r8, i8 = [], s6 = c2(i8, t5, e6, this._aggregateValueRanges, true);
  ...
  _injectOverrides(e5) {
    ...
    const a10 = e5.toJSON();
    return a10.hiddenIds = Array.from(this._visibilityOverrides), a10;
  }
  _addFloorFilterClause(e5) {
    ...
    if ("floorInfo" in t5 && t5.floorInfo) {
      ...
      let a10 = "(" + s6 + " IN ({ids}) OR " + s6 + " IS NULL)";
      if (a10 = a10.replace("{ids}", i8.join(", ")), null != r8 && r8.includes(s6)) {
        let e7 = new RegExp("AND \\(" + s6 + ".*NULL\\)", "g");
        r8 = r8.replace(e7, ""), e7 = new RegExp("\\(" + s6 + ".*NULL\\)", "g"), r8 = r8.replace(e7, ""), r8 = r8.replaceAll(/\s+/g, " ").trim();
      }
      r8 = "" !== r8 ? "(" + r8 + ") AND " + a10 : a10;
    }
    return "" !== r8 ? r8 : null;
  }
  _createConfiguration(e5, t5, r8) {
    const i8 = "feature" === this.layer.type && this.layer.historicMoment ? this.layer.historicMoment.getTime() : void 0, s6 = "feature" === this.layer.type ? this.layer.gdbVersion ?? void 0 : void 0, a10 = new Array(V2), n9 = this._injectOverrides(t5);
    a10[0] = n9, a10[1] = null != r8 ? r8.toJSON() : null;
    const o9 = w3(e5);
    if (null == o9)
      return null;
    const l8 = n3("2d");
    return { availableFields: this.availableFields, gdbVersion: s6, historicMoment: i8, devicePixelRatio: window.devicePixelRatio || 1, filters: a10, schema: o9, supportsTextureFloat: l8.supportsTextureFloat, maxTextureSize: l8.maxTextureSize };
  }
...
//# sourceMappingURL=chunk-G2OBQKR7.js.map
