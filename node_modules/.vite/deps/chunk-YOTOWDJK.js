...
var p = class extends m {
  ...
  initialize() {
    ...
    this._queue = new u({ concurrency: e2, process: (e3, s) => {
  ...
  _peekByScaleFirst(e2) {
    ...
    e2.forEach((e3) => {
      ...
      h.has(o2) || (h.set(o2, []), s = Math.max(o2, s), r = Math.min(o2, r)), h.get(o2).push(t2.key), a2.add(o2);
    });
    let o = this.state.scale;
    h.has(o) || (u2(c, a2), c.sort((e3, t2) => e3 - t2), o = c.reduce((e3, t2) => Math.abs(t2 - o) < Math.abs(e3 - o) ? t2 : e3, c[0])), o = Math.min(o, s), o = Math.max(o, r);
...
e([y({ constructOnly: true })], p.prototype, "concurrency", void 0), e([y({ constructOnly: true })], p.prototype, "process", void 0), e([y()], p.prototype, "state", void 0), e([y({ constructOnly: true })], p.prototype, "strategy", void 0), e([y({ constructOnly: true })], p.prototype, "tileInfoView", void 0), e([y({ readOnly: true })], p.prototype, "updating", null), p = e([a("esri.views.2d.tiling.PagedTileQueue")], p);
//# sourceMappingURL=chunk-YOTOWDJK.js.map
