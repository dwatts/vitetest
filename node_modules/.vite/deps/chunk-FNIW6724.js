...
var o2 = class extends i2 {
  ...
  setTransform(r3) {
    ...
    const m4 = (n3.extent.xmax - n3.extent.xmin) / n3.size[0] / r3.resolution, d7 = M(r3.rotation), { dvs: c6 } = this.transforms;
...
var h5 = d5;
function y3(t7, o3) {
  const i6 = new x({ x: (t7.xmax + t7.xmin) / 2, y: (t7.ymax + t7.ymin) / 2, spatialReference: t7.spatialReference }), s5 = t7.xmax - t7.xmin, r3 = t7.ymax - t7.ymin, a4 = Math.abs(Math.cos(M(o3))), n3 = Math.abs(Math.sin(M(o3))), p3 = a4 * s5 + n3 * r3, m4 = n3 * s5 + a4 * r3, d7 = new M2({ xmin: i6.x - p3 / 2, ymin: i6.y - m4 / 2, xmax: i6.x + p3 / 2, ymax: i6.y + m4 / 2, spatialReference: t7.spatialReference });
...
//# sourceMappingURL=chunk-FNIW6724.js.map
