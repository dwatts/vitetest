...
function i(t2, s) {
  ...
  try {
    let r = `this.${s} = null;`;
    for (const s2 in t2) {
      r += `this${u.test(s2) ? `.${s2}` : `["${s2}"]`} = ${JSON.stringify(t2[s2])};`;
    }
...
//# sourceMappingURL=chunk-LNX43VM5.js.map
